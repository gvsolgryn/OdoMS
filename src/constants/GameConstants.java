...
public class GameConstants {
    ...
    public static int[] autolootblockedMaps = {280030000, 280030100, 240060200, 240060201, 270050100, 211070100, 211070102, 401060100, 271040100, 105200110, 105200111, 105200210, 105200610, 
    ...
    public static int getExpModByLevel(int level) { //레벨별 경험치
        if (level < 10) {
            return 2;
        } else if (level >= 150 && level < 999) {
            return 1;
        } else if (level >= 999) {
            return 1;
        } else {
    ...
    public static boolean moblimit2(final int mapid) { //젠률 맵추가
        int[] chackMapid = {
            211060100, //성벽 아래 1
            211060300, //성벽 아래 2
            211060500, //성벽 아래 3
    ...
    public static boolean moblimit3(final int mapid) { //젠률 맵추가
        int[] chackMapid = { //270030200,
        //271030310, //무기고1
        //271030320, //무기고2
        };
        for (int i = 0; i < chackMapid.length; i++) {
