...
//         // 0 : 돼지고기볶음, 1 : 달팽이요리, 2 : 해파리냉채, 3 : 버섯칼국수, 4 : 슬라임푸딩
    ...
    public static boolean 차단맵(int mapid) {
        switch (mapid) {
            case 13000:
            case 13001:
            case 13002:
    ...
    public static boolean isDarkAtackSkill(int skillId) {
        return (skillId == 400041059 || skillId == 14101021 || skillId == 14111021 || skillId == 14101028 || skillId == 14101029 || skillId == 14121002 || skillId == 14000027 || skillId == 14000028 || skillId == 14000029 || skillId == 14001027 || skillId == 14121016);
    }
