...
public class GarbageDataBaseRemover {
    ...
    public static void main(String args[]) {
        System.out.println("[알림] 데이터베이스 정리 시작\r\n");
        int deletedrows = 0;
        ...
        try {
            ...
            System.out.println("[알림] Deleting the garbage database from the 'characters' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'inventoryitems' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'inventoryequipment' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'inventoryslot' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'keymap' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'keyvalue' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'keyvalue2' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'mountdata' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'skills' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'pets' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'android' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'buddies' table...");
            ...
            System.out.println("[알림] Deleting the garbage database from the 'guilds' table...");
        ...
        System.out.println("\r\n[알림] GarbageDataBaseRemover Complete, Remove Size : " + (EquipRemover.rm + deletedrows) + "\r\n");
    }
}
