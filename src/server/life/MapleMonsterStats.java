...
public class MapleMonsterStats {
    ...
    private long hp;
    private int pddamage, mddamage, link, id, exp, mp, removeAfter, buffToGive, fixedDamage, selfDestruction_hp, dropItemPeriod, point, eva, acc, PhysicalAttack, MagicAttack, speed, partyBonusR, pushed;
