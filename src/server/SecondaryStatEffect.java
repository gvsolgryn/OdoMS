...
public class SecondaryStatEffect
        ...
        try {
            ...
            if (ret.skill) {
                switch (sourceid) {
                    ...
                    case 80002421: {
                        //localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 3000));
                            ret.statups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 3000));
                        break;
                    }
                    case 1301006: {
                    ...
                    case 11121054: {
                        ret.statups.put(SecondaryStat.IndieDamR, new Pair<>((int) ret.indieDamR, ret.duration));
                        ret.statups.put(SecondaryStat.IndieIgnoreMobPdpR, new Pair<>((int) ret.indieIgnoreMobpdpR, ret.duration));
                        ret.statups.put(SecondaryStat.CosmicForge, new Pair<>((int) ret.x, ret.duration));
                        break;
                    }
                    case 12101022: {
                    ...
                    case 12101024: {
                        ret.duration = 0;
                        ret.statups.put(SecondaryStat.OrbitalExplosion, new Pair<Integer, Integer>(1, ret.duration));
                        break;
                    }
                    case 12121003: {
                    ...
                    case 27111009: {
                        ret.duration = 0;
                        ret.statups.put(SecondaryStat.EquilibriumLiberation, new Pair<Integer, Integer>(1, ret.duration));
                    }
                    case 15121004: {
                        ret.duration = 0;
                        ret.statups.put(SecondaryStat.ShadowPartner, new Pair<Integer, Integer>(ret.x, ret.duration));
                ...
                switch (sourceid) {
                    ...
                    case 2450163: {
                        ret.statups.put(SecondaryStat.ExpBuffRate, new Pair<Integer, Integer>(300, ret.duration));
                        break;
                    }
            ...
            block197:
            {
                block195:
                {
                    ...
                    if (MapleSkillManager.isUnstableMemorizeSkills(this.sourceid)) {
                        applyto.getClient().getSession().writeAndFlush((Object) CField.skillCooldown(400001021, localDuration));
                    } else if (this.sourceid == 2221012) {
                        applyto.getClient().getSession().writeAndFlush((Object) CField.skillCooldown(400001021, 5000));
                    }
                    ...
                    if ((summonMovementType = this.getSummonMovementType()) != null && ((this.sourceid == 400021071 || this.sourceid == 35111008 || this.sourceid == 35120002 || this.sourceid == 400021092) && primary || this.sourceid != 400021071 && this.sourceid != 35111008 && this.sourceid != 35120002 && this.sourceid != 400021092)) {
                        ...
                        if (spawn) {
                            ...
                            if (this.sourceid == 400011077) {
                                ...
                                if (count.size() == 3) {
                                  //  applyfrom.dropMessageGM(6, "버프 작동함20");
                                ...
                                for (MapleMapObject obj : objs) {
                                    atom.addForceAtom(new server.maps.ForceAtom(1, Randomizer.rand(52, 72), Randomizer.rand(5, 6), Randomizer.rand(33, 72), 1440, applyfrom.getTruePosition()));
                                ...
                                server.maps.ForceAtom forceAtom = new server.maps.ForceAtom(1, 49, 5, Randomizer.rand(45, 90), 1440);
                                atom.addForceAtom(forceAtom);
                                applyfrom.getMap().spawnMapleAtom(atom);
                            }
                        }
                     //   applyto.dropMessageGM(6, "버프 작동함10");
                    ...
                    //applyto.dropMessageGM(6, "버프 작동함11");
    ...
    private final void applyBuffEffect(MapleCharacter applyfrom, MapleCharacter applyto, boolean primary, int newDuration, Point pos, boolean showEffect) {
        ...
        if (applyto.getKeyValue(9999, "skillid") > 0
                || applyto.getKeyValue(9999, "skillid2") > 0
                || applyto.getKeyValue(9999, "skillid3") > 0
                || applyto.getKeyValue(9999, "skillid4") > 0
                || applyto.getKeyValue(9999, "skillid5") > 0
                || applyto.getKeyValue(9999, "skillid6") > 0) {
            isPetBuff = false;
        }
     ...
     //   applyto.dropMessageGM(6, "버프 작동함3");
        block3:
        switch (this.sourceid) {
            case 1121010: {
            ...
            //칼리
            case 154110005: { //칼리 : 디시빙 블레이드
                localstatups.clear();
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(this.w, 10000));
            }
                break;

            case 80003224:
            case 150033224: {//칼리 : 이네이트 기프트

                localstatups.clear();
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(this.w, 50000));
                break;

            }

            case 400041089: { //칼리 : 레조네이트 - 얼티메이텀 [수정필요]
                localstatups.clear();
                localstatups.put(SecondaryStat.ResonateUltimatum, new Pair<Integer, Integer>(1, 50000));
                break;
            }

            case 154121004: { // 칼리 : 데저트베일
                localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(this.x, localDuration));
                break;
            }
            case 154121009:
            case 154100003:
            case 154110003:
            case 154120003:
            case 154101009: { // 칼리 : 보이드 러쉬
                localstatups.clear();
                localstatups.put(SecondaryStat.DarkSight, new Pair<Integer, Integer>(1, 3000));
                break;
            }
            case 154111000: { // 칼리 : 서먼 차크리
                localstatups.put(SecondaryStat.SummonChakri, new Pair<Integer, Integer>(this.x, 0));
                break;
            }
            case 154111007: { // 칼리 : 보이드인핸스
                localstatups.put(SecondaryStat.VoydEnhance, new Pair<Integer, Integer>(this.x, 0));
                break;
            }
            case 154121005: { // 칼리 : 레프의 용사
                localstatups.put(SecondaryStat.BasicStatUp, new Pair<Integer, Integer>(this.x, localDuration));
                break;
            }
            case 154121041: { // 칼리 : 데스 블로섬
                localstatups.put(SecondaryStat.IndieSummon, new Pair<Integer, Integer>(this.x, localDuration));
                break;
            }
            case 154101005: { // 칼리 : 차크람 부스터
                localstatups.put(SecondaryStat.Booster, new Pair<Integer, Integer>(this.x, localDuration));
                break;
            }
            case 154121043: { // 칼리 : 오블리비온
                int[] hexSkills = {154121001,154121002,154111006};

                for (int reduceSkills : hexSkills) {
                    int reduceAmount = SkillFactory.getSkill(reduceSkills).getEffect(applyto.getSkillLevel(reduceSkills)).getCooldown(applyto);
                    applyto.addCooldown(reduceSkills, System.currentTimeMillis(), reduceAmount / 2);
                }

                applyto.removeCooldown(154111004);
                applyto.removeCooldown(154121011);
                System.err.println("tprtm");
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(this.x, localDuration));
                break;
            }

            case 154111004: { // 칼리 : 보이드러쉬
            ...
            case 12121054: {
                localstatups.put(SecondaryStat.PhoenixDrive, new Pair<Integer, Integer>(1, localDuration / 2));
                // todo 스킬 쿨타임 줄때
                applyto.addCooldown(12121054, System.currentTimeMillis(), this.cooltime);
                applyto.getClient().getSession().writeAndFlush((Object) CField.skillCooldown(12121054, this.cooltime));
            }
            case 1301013: {
                bufftimeR = false;
            ...
            case 13121017: {
                if (!applyto.getBuffedValue(13121017)) {
                    localstatups.put(SecondaryStat.StormBringer, new Pair<Integer, Integer>(this.x, localDuration));
                }
                break;
            }
            
            case 13121055: {
                if (!applyto.getBuffedValue(13121055)) {
                    localstatups.put(SecondaryStat.StormWimb, new Pair<Integer, Integer>(this.x, localDuration));
                }
                break;
            }
            ...
            case 150030241: {
                ...
                localstatups.put(SecondaryStat.IndieUnk2, new Pair<Integer, Integer>(1, localDuration));
                localstatups.put(SecondaryStat.IndieDarkness, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 2321016: {
            ...
            case 400011038: {
                localstatups.clear();
                localstatups.put(SecondaryStat.BloodFist, new Pair<Integer, Integer>(1, localDuration));
                applyto.addCooldown(400011038, System.currentTimeMillis(), 12000);
                applyto.getClient().getSession().writeAndFlush((Object) CField.skillCooldown(400011038, 12000));
                break;
            }
            case 2321005: {
         ...
         /*  case 4341002: {
                ...
                if (applyto.getKeyValue(1234, "ww_cut") != 1) {
                    localstatups.put(SecondaryStat.NotDamaged, new Pair<Integer, Integer>(1, 3000));
                } else {
                    localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(40, 0));
                }
                break;
            }*/
            ...
            case 11001024: {
                ...
                if (applyto.getSkillLevel(11110032) > 0 && applyto.getSkillLevel(11120009) < 0) {
                    cr = 20;
                } else if (applyto.getSkillLevel(11110032) > 0 && applyto.getSkillLevel(11120009) > 0) {
                    cr = 35;
                }
                localstatups.put(SecondaryStat.PoseType, new Pair<>(1, 0));
                localstatups.put(SecondaryStat.Buckshot, new Pair<>(1, 0));
                localstatups.put(SecondaryStat.IndieCr, new Pair<>(cr, 0));
            ...
            case 11001025: {
                ...
                if (applyto.getSkillLevel(11110032) > 0 && applyto.getSkillLevel(11120009) < 0) { // 솔루나 마스터리
                    pmd = 20;
                    booster = -1;
                } else if (applyto.getSkillLevel(11110032) > 0 && applyto.getSkillLevel(11120009) > 0) { // 마스터 오브 더 소드
                    pmd = 25;
                    booster = -2;
                }
                ...
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(pmd, 0));
            ...
            case 11101031: {
                localstatups.clear();
                localstatups.put(SecondaryStat.GlimmeringTime, new Pair<Integer, Integer>(1, 0));
                break;
            }
            case 11121012: {
                aftercancel = true;
                ...
                localstatups.put(SecondaryStat.Buckshot, new Pair<Integer, Integer>(SkillFactory.getSkill((int) 11001024).getEffect((int) applyto.getSkillLevel((int) 11001024)).x, 0));
                break;
            }
            case 11121011: {
                aftercancel = true;
            ...
            case 12111023: {
                localstatups.clear();
                if (primary) {
                    localstatups.put(SecondaryStat.FlareTrick, new Pair<Integer, Integer>(this.y, 2790000));
                    break;
                }
                bufftimeR = false;
            ...
            case 14121052: {
                ...
                localDuration = 30000;
                aftercancel = true;
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(20, localDuration));
           ...
           //     localstatups.put(SecondaryStat.AranSmashSwing, new Pair<Integer, Integer>(983040, 4999));
            ...
            case 20031210: {
                ...
                while (true) {
                    ...
                    atom.addForceAtom(new server.maps.ForceAtom(2, Randomizer.rand(15, 29), Randomizer.rand(7, 11), Randomizer.rand(0, 9), 0));
                    ++i;
                }
            ...
            case 400021003: {
                ...
                localstatups.clear();
                if (!showEffect) {
                    localDuration = SkillFactory.getSkill((int) 400021003).getEffect((int) applyto.getSkillLevel((int) 400021003)).duration;
                }
                    localstatups.put(SecondaryStat.Pray, new Pair<Integer, Integer>(Integer.valueOf(level), localDuration));
                    break;
                }
            case 24111002: {
                localstatups.clear();
            ...
            case 32121017: {
                ...
                if (applyto.addBuffCheck == 1) {
                    ...
                    localstatups.put(SecondaryStat.IndieBDR, new Pair<Integer, Integer>(20, localDuration));
                }
            ...
            case 33111007: {
                ...
                localstatups.put(SecondaryStat.BeastFormDamage, new Pair<Integer, Integer>(1, localDuration));
            ...
            case 12120014: {
                localstatups.clear();
                localstatups.put(SecondaryStat.IgnoreTargetDEF, new Pair<Integer, Integer>(1, localDuration));
                break;
            }
            case 51111004: {
                int asr = this.y;
            ...
            case 400001045: {
                ...
                localstatups.put(SecondaryStat.Bless5th2, new Pair<Integer, Integer>(1, 0));
            ...
            case 400001044: {
                localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(10, localDuration));
                localstatups.put(SecondaryStat.IndieDamageReduce, new Pair<Integer, Integer>(10, localDuration));
                localstatups.put(SecondaryStat.Bless5th, new Pair<Integer, Integer>(applyfrom.메이플용사,localDuration));
                break;
            }
            case 400001047: {
            ...
            case 400011011: {
                ...
                if (applyto.getId() == applyfrom.getId()) {
                    if (applyfrom.getBuffedEffect(SecondaryStat.RhoAias) != null || !primary) {
                        ...
                        localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(this.u, this.q2 * 1000));
            ...
            case 80002393: {
                ...
                if (!applyto.getBuffedValue(80002393)) {
                    localstatups.put(SecondaryStat.IndieNotDamaged, new Pair<Integer, Integer>(1, 30000));
                    localstatups.put(SecondaryStat.NotDamaged, new Pair<>(1, 30000));
                    break;
                }
            }
            ...
            case 400011089: {
                ...
                List<RangeAttack> skills = new ArrayList<RangeAttack>();
                skills.add(new RangeAttack(400011089, applyto.getPosition(), 0, 0, 5));
                applyto.getClient().getSession().writeAndFlush((Object) CField.rangeAttack(400011088, skills));
            ...
            case 400041032: { //레디 투 다이
                ...
                if (applyto.getBuffedValue(400041032) || applyto.getKeyValue(1544, "" + 400041032 + "") ==1L ) {
                    localstatups.put(SecondaryStat.IndieEvasion, new Pair<Integer, Integer>(this.w, localDuration));
                    localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(this.q, (int) localDuration));
                    localstatups.put(SecondaryStat.IndieShotDamage, new Pair<Integer, Integer>(this.s, localDuration));
                    localstatups.put(SecondaryStat.ReadyToDie, new Pair<Integer, Integer>(2, (int) localDuration));
                    break;
                }
            ...
            case 400051044: {
                ...
                skills.add(new RangeAttack(400051045, applyto.getPosition(), applyto.isFacingLeft() ? -1 : 0, 0, 0));
                skills.add(new RangeAttack(400051045, applyto.getPosition(), applyto.isFacingLeft() ? -1 : 0, 0, 0));
                applyto.getClient().getSession().writeAndFlush((Object) CField.rangeAttack(400051096, skills));
            ...
            case 1321020: {
                ...
                localstatups.put(SecondaryStat.ReincarnationAccept, new Pair<Integer, Integer>(applyto.리인카네이션, localDuration));
                break;
            }
            case 5101017: {
            ...
            case 11001022: {
                localstatups.put(SecondaryStat.ElementSoul, new Pair<>((int) level, 0));
                break;
            }
            case 11001027: {
                int pad = this.indiePad;
                int time = localDuration;
                if (applyto.getCosmicCount() > 0) {
                    SecondaryStatEffect ef = SkillFactory.getSkill(11001022).getEffect(applyto.getSkillLevel(11001022));
                    pad = ef.getU2();
                    time = ef.getU();
                }
                localstatups.put(SecondaryStat.IndiePad, new Pair<>(pad, time));
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<>((int) indiePmdR, localDuration));
                break;
            }
            case 11001030: {
                localstatups.put(SecondaryStat.CosmicOrb, new Pair<>((int) applyfrom.getCosmicCount(), localDuration));
                break;
            }
            case 13001022: {
                localstatups.put(SecondaryStat.CygnusElementSkill, new Pair<Integer, Integer>(1, 0));
            ...
            case 400011142: {
                localstatups.put(SecondaryStat.Cosmos, new Pair<>(applyfrom.getCosmicCount(), u * 1000));
                break;
            }
            case 14001021: {
            ...
            case 400001042: {
                ...
                localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(Integer.valueOf(this.indieDamR), localDuration));
                localstatups.put(SecondaryStat.Bless5th2, new Pair<Integer, Integer>(applyfrom.메이플용사, localDuration));
                break;
            }

            case 80002416: //앵무새 버프
                int a = 40;
                localstatups.put(SecondaryStat.IndieMad, new Pair<Integer, Integer>(a, 0));
                localstatups.put(SecondaryStat.IndiePad, new Pair<Integer, Integer>(a, 0));
                localstatups.put(SecondaryStat.IndieCD, new Pair<Integer, Integer>(a, 0));
                localstatups.put(SecondaryStat.IndieBDR, new Pair<Integer, Integer>(a, 0));
                localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(a, 0));
                localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>(a, 0));
                break;

            //계승자 버프
            case 80001538: {
                localstatups.clear();
                List<Integer> effects2 = applyfrom.getsuccessorEffect();
                SecondaryStat[] stats2 = {
                        SecondaryStat.IndieStr,
                        SecondaryStat.IndieDex,
                        SecondaryStat.IndieInt,
                        SecondaryStat.IndieLuk,
                        SecondaryStat.IndiePmdR };

                for (int i = 0; i < 5; i++) {
                    int value = effects2.get(i);
                    applyfrom.setEffect2(i, effects2.get(i));
                    if (value > 0)
                        localstatups.put(stats2[i], new Pair<>(value , 0));
                }
                break;
            }
            ...
            case 80002419: {
                ...
                SecondaryStat[] stats = {
                        SecondaryStat.IndieDamR,
                        SecondaryStat.IndieExp,
                        SecondaryStat.DropRate,
                        SecondaryStat.MesoUp,
                        SecondaryStat.IndieCD,
                        SecondaryStat.IndieBDR,
                        SecondaryStat.IndieAllStatR,
                        SecondaryStat.IndiePmdR };
            ...
            case 1111003: {
                ...
                localstatups.put(SecondaryStat.ComboCostInc, new Pair<Integer, Integer>((int) applyto.getSkillCustomValue0(1111003), 20000));
                bufftimeR = false;
                break;
            }
            case 80003025: {
            ...
            case 15511003: { 
                localstatups.put(SecondaryStat.IndiePad, new Pair<>((int) indiePad * (applyto.getBuffedValue(155121043) ? 2 : 1), localDuration));
                localstatups.put(SecondaryStat.IndieCr, new Pair<>((int) indieCr * (applyto.getBuffedValue(155121043) ? 2 : 1), localDuration));
                break;
            }
            case 15511105: { 
                localstatups.put(SecondaryStat.IndieBooster, new Pair<>((int) (applyto.getBuffedValue(155121043) ? -2 : -1), localDuration));
                localstatups.put(SecondaryStat.IndieEvaR, new Pair<>((int) indieEvaR * (applyto.getBuffedValue(155121043) ? 2 : 1), localDuration));
                break;
            }
            case 15512105: {
                localstatups.put(SecondaryStat.IndieDamR, new Pair<>((int) indieDamR * (applyto.getBuffedValue(155121043) ? 2 : 1), localDuration));
                localstatups.put(SecondaryStat.IndieBDR, new Pair<>((int) indieBDR * (applyto.getBuffedValue(155121043) ? 2 : 1), localDuration));
                break;
            }
            case 400011091: {
                localstatups.clear();
            ...
            case 5321054: { // 벅샷
                localDuration = 0;
                localstatups.clear();
                if (GameConstants.isCannon(applyto.getJob()) && applyto.hasDonationSkill(5321054)) { // GameConstants.isCannon(applyto.getJob()) &&
                    localstatups.put(SecondaryStat.IndiePmdR, new Pair<Integer, Integer>(-45, localDuration));
                    localstatups.put(SecondaryStat.IndieBooster, new Pair<Integer, Integer>(-1, localDuration));
                    localstatups.put(SecondaryStat.Buckshot, new Pair<Integer, Integer>(Integer.valueOf(this.x), localDuration));
            ...
            case 1311015: {
                ...
                if (GameConstants.isDarkKnight(applyto.getJob()) && applyto.hasDonationSkill(1311015)) {
                    localstatups.put(SecondaryStat.CrossOverChain, new Pair<Integer, Integer>(x * 2, localDuration));;
                } else {
                    localstatups.put(SecondaryStat.CrossOverChain, new Pair<Integer, Integer>(x, localDuration));;
                }
                break;
            }
            case 1210016: {
        ...
        //applyto.dropMessageGM(6, "버프 작동함2");
      ...
      //  applyto.dropMessageGM(6, "버프 작동함");
        ...
        if (this.sourceid == 80002419 && applyto.getKeyValue(800023, "indiepmer") > 0) {
            localstatups.put(SecondaryStat.IndieDamR, new Pair<Integer, Integer>((int) applyto.getKeyValue(800023, "indiepmer"), 0));
        }
