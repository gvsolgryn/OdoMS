    ...
    public final Item scrollEquipWithId(Item equip, Item scrollId, boolean ws, MapleCharacter chr) {
        if (equip.getType() == 1) {
            ...
            switch (scrollId.getItemId()) {
                ...
                case 2046026:
                case 2046119:
                    //nEquip.setWatk((short)10);
                    statz = new ArrayList<>();
                    allstat = 5;
                    rand = Randomizer.rand(10, 10);
                ...
                case 2049050:
                    ...
                    switch (scrollId.getItemId()) {
                        ...
                        case 2049052: //업글 횟수추가 mush
                            ...
                            break;
                        case 2046025:
                            nEquip.setWatk((short) (nEquip.getWatk() + Randomizer.rand(10, 10)));
                            break;
                        case 2046026:
                            nEquip.setMatk((short) (nEquip.getMatk() + Randomizer.rand(10, 10)));
                            break;
                        case 2046340:
                        ...
                        case 2046139:
                            ...
                            nEquip.setAcc((short) (nEquip.getAcc() + 10));
                            break;
                        case 2046058:
                        case 2046059:
                        case 2046140:
