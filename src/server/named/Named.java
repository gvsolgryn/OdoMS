...
public class Named {
    ...
    public static String namedTime = "-ºÐ --ÃÊ";
    ...
    public static class NamedHandle implements Runnable {
        ...
        public NamedHandle() throws MalformedURLException, IOException {
            // page = new URL("http://127.0.0.1/data/json/ladder/result.json");
        ...
        public void run() {
            ...
            String countdown_clock = countdown_ii + "ºÐ " + countdown_ss + "ÃÊ";
            ...
            if (countdown_ii == 0 && countdown_ss == 0) {
                try {
                    ...
                    //WorldBroadcasting.broadcastMessage(MainPacketCreator.OnAddPopupSay(9001198, 3000, "#r" + times + "#kÈ¸Â÷ ³×ÀÓµå È¦,Â¦ °á°ú´Â\r\n[#b" + getScoreString(start_point + " " + line_count + " " + odd_even) + "#k] ÀÔ´Ï´Ù.", ""));
                    WorldBroadcasting.broadcastMessage(MainPacketCreator.getGMText(9, "[ÃÊ¿ø¿Â¶óÀÎ ¾Ë¸®¹Ì] " + times + "È¸Â÷ ³×ÀÓµå È¦,Â¦ °á°ú´Â [" + getScoreString(start_point + " " + line_count + " " + odd_even) + "] ÀÔ´Ï´Ù."));
