...
public class MapleAchievement {
    ...
    public void finishAchievement(MapleCharacter chr) {
        chr.modifyCSPoints(3, reward, false);
        ...
        if (notice && !chr.isGM()) {
            ...
            World.Broadcast.broadcastMessage(MaplePacketCreator.serverNotice(5, "[히든미션] " + chr.getName() + "님이 (" + name + ") 미션을 완료해 " + reward + "마일리지를 획득했습니다."));
        }
    }
}
