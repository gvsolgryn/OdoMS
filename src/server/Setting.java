...
public class Setting {
  public static void setting() {
    try {
      ...
      System.out.println("[알림] " + ServerConstants.boss.size() + "개의 몬스터 체력 로딩완료.");
    } catch (Exception ex) {
      ex.printStackTrace();
    } 
  }
  ...
  public static void setting2() {
    try {
      ...
      for (int i = 0; i < list.size(); i++);
      System.out.println("[알림] " + ServerConstants.boss2.size() + "개의 몬스터 체력 로딩완료.");
    } catch (Exception ex) {
      ex.printStackTrace();
    } 
  }
  ...
  public static void settingGoldApple() {
    try {
      ...
      System.out.println("[알림] 골드애플 일반 아이템 갯수 : " + ServerConstants.goldapple.size() + "개 로딩 완료.");
      System.out.println("[알림] 골드애플 스페셜 아이템 갯수 : " + ServerConstants.Sgoldapple.size() + "개 로딩 완료.");
      System.out.println("[알림] 골드애플 스페셜 아이템 확률 : '" + ServerConstants.SgoldappleSuc + "%' 로딩 완료.");
    } catch (Exception ex) {
      ex.printStackTrace();
    } 
  }
  ...
  public static void settingNeoPos() {
    try {
      ...
      System.out.println("[알림] 위시코인 리스트 : " + ServerConstants.NeoPosList.size() + "개 로딩 완료.");
    } catch (Exception ex) {
      ex.printStackTrace();
    } 
  }
