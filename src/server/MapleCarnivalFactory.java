...
public class MapleCarnivalFactory {
    ...
    public static class MCSkill {
        ...
        public MapleDisease getDisease() {
            /*if (skillid <= 0) {
             //System.out.println("here rand");
             while (true) {
             MapleDisease dis = MapleDisease.getRandom();
             if (dis != MapleDisease.SEDUCE && dis != MapleDisease.FREEZE && dis != MapleDisease.ZOMBIFY && dis != MapleDisease.WEIRD_FLAME && dis != MapleDisease.POTION && dis != MapleDisease.SHADOW && dis != MapleDisease.BLIND) {
             return dis;
             }
             }
             }*/
