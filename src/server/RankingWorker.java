...
public class RankingWorker {
    ...
    public final static void loadJobCommands() {
        //messy, cleanup
        jobCommands.put("모든 직업", -1);
        jobCommands.put("초보자", 0);
        jobCommands.put("전사", 1);
        jobCommands.put("마법사", 2);
        jobCommands.put("궁수", 3);
        jobCommands.put("도적", 4);
        jobCommands.put("해적", 5);
        jobCommands.put("노블레스", 10);
        jobCommands.put("소울마스터", 11);
        jobCommands.put("플레임위자드", 12);
        jobCommands.put("윈드브레이커", 13);
        jobCommands.put("나이트워커", 14);
        jobCommands.put("스트라이커", 15);
        jobCommands.put("레전드", 20);
        jobCommands.put("아란", 21);
        jobCommands.put("에반", 22);
        jobCommands.put("시티즌", 30);
        jobCommands.put("배틀메이지", 32);
        jobCommands.put("와일드헌터", 33);
        jobCommands.put("메카닉", 35);
    }
