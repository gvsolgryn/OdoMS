...
public class CharacterTransfer implements Externalizable {
    ...
    public int characterid, accountid, exp, fame, pvpExp, pvpPoints,
            meso, hair, face, mapid, guildid, sidekick, DonateCash, 
            partyid, messengerid, ACash, MaplePoints, ultimate, 
            mount_itemid, mount_exp, points, vpoints, marriageId, maxhp, maxmp, hp, mp,
            familyid, seniorid, junior1, junior2, currentrep, totalrep, battleshipHP, gachexp, guildContribution, totalWins, totalLosses, pcdate, itemEffect;
    public byte channel, gender, gmLevel, guildrank, alliancerank,
            fairyExp, buddysize, world, initialSpawnPoint, skinColor, mount_level, mount_Fatigue, subcategory, spawnPoint;
    public long lastfametime, TranferTime, pctime;
    public long damagetotal, extraexp;
    public String name, accountname, BlessOfFairy, BlessOfEmpress, chalkboard, tempIP;
    public short level, str, dex, int_, luk, remainingAp, hpApUsed, job, fatigue, emblem;
    ...
    public FileTime equipExtExpire;
    ...
    public final Map<String, String> keyValues = new LinkedHashMap<>();
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        if (chr.getPcDate() == GameConstants.getCurrentDate_NoTime()) {//pc 방
            this.pctime = chr.getPcTime();
            this.pcdate = chr.getPcDate();
        }
        this.vpoints = chr.getCSPoints(3);        
        ...
        this.ultimate = chr.getUltimate();
        this.WATKValue = chr.WATKValue;
        this.MATKValue = chr.MATKValue;
        this.boosterVal = chr.boosterVal;
        this.lCTS = chr.lCTS;
        this.mobKillCount = chr.mobKillCount;
        this.extraexp = chr.getExtraExp();
        this.equipExtExpire = chr.getEquipExtExpire();
        boolean uneq = false;
...
//        for (Entry<String, String> entry : chr.getKeyValues().entrySet()) {
...
//        }
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.ultimate = in.readInt();
        this.extraexp = in.readLong();//문제시
        this.equipExtExpire = FileTime.longToFileTime(in.readLong());
        ...
        final int keyValueSize = in.readShort();
        for (int i = 0; i < keyValueSize; i++) {
            this.keyValues.put(in.readUTF(), in.readUTF());
        }
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.write(this.ultimate);
        out.writeLong(extraexp);//문제시
        out.writeLong(equipExtExpire.fileTimeToLong());
        ...
        out.writeShort(this.keyValues.size());
