...
public class MapleCrypto {
    ...
    private static final byte[] sSecretKey = new byte[]{
        (byte) 0xCA, 0x00, 0x00, 0x00, (byte) 0x89, 0x00, 0x00, 0x00,
        (byte) 0xFD, 0x00, 0x00, 0x00, (byte) 0xF6, 0x00, 0x00, 0x00, 
        (byte) 0x99, 0x00, 0x00, 0x00, (byte) 0xF0, 0x00, 0x00, 0x00, 
        (byte) 0xA6, 0x00, 0x00, 0x00, (byte) 0x0B, 0x00, 0x00, 0x00
    };
    ...
    */
    ...
    private static final byte[] sShiftKey = new byte[]{(byte) 0xEC, (byte) 0x3F, (byte) 0x77, (byte) 0xA4,
    ...
    public MapleCrypto(byte iv[], short mapleVersion, boolean isChannel) {
        this(iv, mapleVersion, isChannel, false);
    }

    public MapleCrypto(byte iv[], short mapleVersion, boolean isChannel, boolean isOutbound) {
    ...
    public byte[] crypt(byte[] data) throws IllegalBlockSizeException, BadPaddingException {
        ...
        if (isChannel && isOutbound) {
            byte[] datac = new byte[data.length];
