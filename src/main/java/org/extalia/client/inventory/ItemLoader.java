...
import org.extalia.server.maps.BossReward;
...
public enum ItemLoader {
    ...
    public static boolean isCanMadeItem(Equip equip) {
        ...
        if ((GameConstants.isArcaneSymbol(equip.getItemId()) || GameConstants.isAuthenticSymbol(equip.getItemId()))  && equip.getItemId() != 1162002
                && equip.getState() > 0) {
