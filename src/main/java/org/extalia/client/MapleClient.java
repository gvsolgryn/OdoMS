...
public class MapleClient {
    ...
    public int login(String login, String pwd, String mac, boolean weblogin, boolean ipMacBanned) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (ServerConstants.ConnectorSetting && !this.isGm() && !this.getSessionIPAddress().equals("125.184.5.40") && !this.getSessionIPAddress().equals("1.246.243.142")) {
                    if (allowed != 1 && gmc < 1) {
    ...
    public String getKeyValue_Boss(String key) {
        if (this.keyValues_boss.containsKey(key)) {
            return this.keyValues_boss.get(key);
        }
        return null;
    }
    ...
    public void saveKeyValue_BossToDB(Connection con) {
        try {
            if (this.keyValues_boss != null) {
                ...
                for (Map.Entry<String, String> keyValue : this.keyValues_boss.entrySet()) {
