...
import org.extalia.client.messages.CommandProcessorUtil;
...
import org.extalia.handling.login.handler.AutoRegister;
...
import org.extalia.scripting.PortalScriptManager;
...
//  }
  ...
  public static class 채팅색 extends  CommandExecute {
    public int execute(MapleClient c, String[] splitted) {
      for (int i = 0; i < 60; i++) {
        World.Broadcast.broadcastMessage(CField.getGameMessage(i, i + ""));
      }
      return 1;
    }
  }
...
/*        MaplePacketLittleEndianWriter packet2 = new MaplePacketLittleEndianWriter();
        packet2.writeShort(829);
        packet2.write(HexTool.getByteArrayFromHexString("01 A1 47 F1 08 C8 00 00 00 02 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00"));
        c.getSession().writeAndFlush(packet2.getPacket());
