...
import org.extalia.server.maps.MapleMap;
...
public class GameConstants {
    ...
    static {
        ...
        GameConstants.dList.add(new Pair("mirrorD_321_0_", ""));
        GameConstants.dList.add(new Pair("mirrorD_321_1_", ""));
        GameConstants.dList.add(new Pair("mirrorD_321_2_", ""));
        GameConstants.dList.add(new Pair("mirrorD_321_3_", ""));
        GameConstants.dList.add(new Pair("mirrorD_322_0_", ""));
        dailyItems.add(new DailyGiftItemInfo(1, 4310325, 10, 0));
        dailyItems.add(new DailyGiftItemInfo(2, 4310325, 10, 0));
        dailyItems.add(new DailyGiftItemInfo(3, 4310325, 10, 0));
        dailyItems.add(new DailyGiftItemInfo(4, 4310325, 20, 0));
        dailyItems.add(new DailyGiftItemInfo(5, 4310325, 15, 0));
        dailyItems.add(new DailyGiftItemInfo(6, 4310325, 15, 0));
        dailyItems.add(new DailyGiftItemInfo(7, 4310325, 30, 0));
        dailyItems.add(new DailyGiftItemInfo(8, 4310325, 15, 0));
        dailyItems.add(new DailyGiftItemInfo(9, 4310325, 15, 0));
        dailyItems.add(new DailyGiftItemInfo(10, 4310325, 15, 0));
        dailyItems.add(new DailyGiftItemInfo(11, 4310325, 25, 0));
        dailyItems.add(new DailyGiftItemInfo(12, 4310325, 20, 0));
        dailyItems.add(new DailyGiftItemInfo(13, 4310325, 20, 0));
        dailyItems.add(new DailyGiftItemInfo(14, 4310325, 40, 0));
        dailyItems.add(new DailyGiftItemInfo(15, 4310325, 20, 0));
        dailyItems.add(new DailyGiftItemInfo(16, 4310325, 20, 0));
        dailyItems.add(new DailyGiftItemInfo(17, 4310325, 20, 0));
        dailyItems.add(new DailyGiftItemInfo(18, 4310325, 30, 0));
        dailyItems.add(new DailyGiftItemInfo(19, 4310325, 25, 0));
        dailyItems.add(new DailyGiftItemInfo(20, 4310325, 25, 0));
        dailyItems.add(new DailyGiftItemInfo(21, 4310325, 50, 0));
        dailyItems.add(new DailyGiftItemInfo(22, 4310325, 30, 0));
        dailyItems.add(new DailyGiftItemInfo(23, 4310325, 30, 0));
        dailyItems.add(new DailyGiftItemInfo(24, 4310325, 30, 0));
        dailyItems.add(new DailyGiftItemInfo(25, 4310325, 40, 0));
        dailyItems.add(new DailyGiftItemInfo(26, 4310325, 50, 0));
        dailyItems.add(new DailyGiftItemInfo(27, 4310325, 50, 0));
        dailyItems.add(new DailyGiftItemInfo(28, 4310325, 100, 0));
        ...
        for (a = 260; a < 275; a++) {
            if (a == 260) {
                exp[a] = 2902427248153L;
            } else if (a == 270) {
                exp[a] = 6412170711400L;
            } else {
        ...
        for (a = 275; a < 300; a++) {
            if (a == 275 || a == 280 || a == 285 || a == 290 || a == 295 || a == 300) {
                ...
                exp[a] = 2058731433259209L;
            } else {
                exp[a] = (long) Math.floor(exp[a - 1] * 1.1D);
            }
        }
        exp[300] = 3000000000000000L;
    }
    ...
    public static final boolean isKhali(int job) {
        return (job == 15003 || (job >= 15400 && job <= 15412));
    }
    ...
    public static boolean JobCodeCheck(int firstjob, int secondjob) {
        ...
        if (isKhali(firstjob) && isKhali(secondjob)) {
            return true;
        }
        return false;
    }

    public static boolean isElementSoul(int skillid) {
        switch (skillid) {
            case 11110228:
            case 11001226:
            case 11120217:
            case 11100228: // 솔라 슬래시
            case 11111230: // 라우드 러쉬
                return true;
            case 11110128:
            case 11001126:
            case 11100128:
            case 11120117: // 루나 디바이드
            case 11111130: // 사일런트 무브
                return true;
        }
        return false;
    }
    ...
    public static boolean isThief(int job) {
        if (isKhali(job) || isDefaultThief(job) || isHoyeong(job) || isNightLord(job) || isShadower(job) || isDualBlade(job) || isNightWalker(job) || isPhantom(job) || isKadena(job) || isXenon(job)) {
            return true;
        }
        return false;
    }
        ...
        if (a1 <= 33121009) {
            ...
            if (a1 > 14121004) {
                ...
                if (a1 > 5221004) {
                    ...
                    if (a1 > 3101008) {
                        if (a1 == 3111013 || a1 == 3121020 || a1 == 3201012) {
                            return true;
                        }
                        v1 = (a1 == 4341002);
                    } else {
...
//         // 0 : 돼지고기볶음, 1 : 달팽이요리, 2 : 해파리냉채, 3 : 버섯칼국수, 4 : 슬라임푸딩
    ...
    public static boolean isDarkAtackSkill(int skillId) {
        return (skillId == 400041059 || skillId == 14101021 || skillId == 14111021 || skillId == 14101028 || skillId == 14101029 || skillId == 14121002 || skillId == 14000027 || skillId == 14000028 || skillId == 14000029 || skillId == 14001027);
    }
    ...
    public static boolean 사출기(int skill) { //사출기 추가
        switch (skill) {
            case 24100003:
            case 24120002:
            case 4100012:
