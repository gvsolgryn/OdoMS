package org.extalia.server.maps;
...
import org.extalia.scripting.EventManager;
...
import org.extalia.server.field.boss.demian.FlyingSwordNode;
import org.extalia.server.field.boss.demian.MapleDelayedAttack;
import org.extalia.server.field.boss.demian.MapleFlyingSword;
import org.extalia.server.field.boss.demian.MapleIncinerateObject;
...
import org.extalia.server.games.BattleGroundGameHandler;
...
import org.extalia.server.polofritto.MapleRandomPortal;
...
/*            if (MapleMap.this.elitetime > 0 && MapleMap.this.isElitebossmap()) {
    ...
    private void dropFromMonster(MapleCharacter chr, MapleMonster mob, boolean instanced) {
        ...
        for (MonsterDropEntry de : finals) {
            ...
            if (chr.getMapId() == 921170004) { //자동사냥
               d1 = d1 / 5;
