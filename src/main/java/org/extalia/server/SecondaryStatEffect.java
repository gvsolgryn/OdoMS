...
import org.extalia.client.inventory.Equip;
import org.extalia.client.inventory.Item;
import org.extalia.client.inventory.MapleInventoryType;
import org.extalia.client.inventory.MaplePet;
...
import org.extalia.provider.MapleDataType;
import org.extalia.server.field.skill.MapleMagicSword;
import org.extalia.server.life.MapleMonster;
import org.extalia.server.maps.*;
import org.extalia.tools.CaltechEval;
                        ...
                        if (spawn) {
                            ...
                            if (this.sourceid == 400011077) {
                                ...
                                for (MapleMapObject obj : objs) {
                                    atom.addForceAtom(new org.extalia.server.maps.ForceAtom(1, Randomizer.rand(52, 72), Randomizer.rand(5, 6), Randomizer.rand(33, 72), 1440, applyfrom.getTruePosition()));
                                ...
                                org.extalia.server.maps.ForceAtom forceAtom = new org.extalia.server.maps.ForceAtom(1, 49, 5, Randomizer.rand(45, 90), 1440);
           ...
           //     localstatups.put(SecondaryStat.AranSmashSwing, new Pair<Integer, Integer>(983040, 4999));
            ...
            case 20031210: {
                ...
                while (true) {
                    ...
                    atom.addForceAtom(new org.extalia.server.maps.ForceAtom(2, Randomizer.rand(15, 29), Randomizer.rand(7, 11), Randomizer.rand(0, 9), 0));
                    ++i;
                }
