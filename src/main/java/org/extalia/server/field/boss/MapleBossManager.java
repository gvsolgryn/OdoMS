package org.extalia.server.field.boss;
                ...
                if (monster.getCustomValue(monster.getId()) == null) {
                    ...
                    if (objtype == 1) {
                        ...
                        for (Integer a : listed) {
                            ...
                            if (delay > 0) {
                                Timer.MapTimer.getInstance().schedule(() -> monster.getMap().broadcastMessage(CField.DebuffObjON(randlist2, (monster.getId() == 8880000))), delay);
                            } else {
