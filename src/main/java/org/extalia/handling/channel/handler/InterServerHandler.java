...
import org.extalia.server.maps.FieldLimitType;
...
public class InterServerHandler {
    ...
    public static final void Loggedin(int playerid, MapleClient c) {
        try {
            ...
            c.getSession().writeAndFlush(SLFCGPacket.StarDustUI("UI/UIWindowEvent.img/2020neoCoin", 1, 1, false));
