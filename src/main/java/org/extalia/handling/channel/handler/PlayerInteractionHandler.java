...
import org.extalia.client.inventory.ItemFlag;
...
import org.extalia.server.shops.MapleMiniGame;
import org.extalia.server.shops.MaplePlayerShop;
import org.extalia.server.shops.MaplePlayerShopItem;
...
import org.extalia.tools.packet.PlayerShopPacket;
            ...
            case CHAT: {
                ...
                if (chr.getTrade() != null) {
                    ...
                    if (iMaplePlayerShop instanceof MapleMiniGame) {
                        iMaplePlayerShop.broadcastToVisitors(PlayerShopPacket.shopChat(chr, chr.getName(), chr.getId(), "" + message, iMaplePlayerShop.getVisitorSlot(chr)));
                    } else {
