...
import org.extalia.client.inventory.MapleRing;
...
import org.extalia.scripting.NPCConversationManager;
import org.extalia.scripting.NPCScriptManager;
import org.extalia.scripting.ReactorScriptManager;
...
import org.extalia.server.life.Spawns;
import org.extalia.server.maps.*;
import org.extalia.server.marriage.MarriageDataEntry;
import org.extalia.server.marriage.MarriageEventAgent;
import org.extalia.server.marriage.MarriageManager;
import org.extalia.server.marriage.MarriageTicketType;
  ...
  public static final void TouchRune(LittleEndianAccessor slea, MapleCharacter chr) {
    ...
    if (GameConstants.isYeti(chr.getJob()) || GameConstants.isPinkBean(chr.getJob())) {
      ...
      switch (chr.getTouchedRune()) {
        case 0: // 재생의 룬
          effect = SkillFactory.getSkill(80001428).getEffect(1); // 재생의 룬 해방
          effect.applyTo(chr, false);
          break;
        case 1: // 파멸의 룬
          effect = SkillFactory.getSkill(80001432).getEffect(1); // 파멸의 룬 해방
          effect.applyTo(chr, false);
          ...
          break;
        case 2: // 천둥의 룬
          effect = SkillFactory.getSkill(80001762).getEffect(1); // 천둥의 룬 해방
          effect.applyTo(chr, false);
          break;
        case 3: // 지진의 룬
          effect = SkillFactory.getSkill(80001757).getEffect(1); // 지진의 룬 해방
          effect.applyTo(chr, false);
          break;
        case 4: // 어둠의 룬
          ...
          effect = SkillFactory.getSkill(80001754).getEffect(1); // 어둠의 룬 해방
          effect.applyTo(chr);
          break;
        case 5: //보물의 룬
          ...
          effect = SkillFactory.getSkill(80001755).getEffect(1); // 보물의 룬 해방
          effect.applyTo(chr);
          break;
        case 6: // 초월의 룬
          effect = SkillFactory.getSkill(80001878).getEffect(1); // 초월의 룬 해방
          effect.applyTo(chr, false);
          break;
        case 7: // 정화의 룬
          effect = SkillFactory.getSkill(80002888).getEffect(1); // 정화의 룬 해방
          effect.applyTo(chr, false);
          break;
        case 8: // 광선의 룬
          effect = SkillFactory.getSkill(80002889).getEffect(1); //  광선의 룬 해방
          effect.applyTo(chr, false);
          break;
        case 9: // 전이의 룬
          effect = SkillFactory.getSkill(80002890).getEffect(1); //  전이의 룬 해방
          effect.applyTo(chr, false);
          break;
      } 
