...
import org.extalia.server.life.Element;
import org.extalia.server.life.MapleLifeFactory;
import org.extalia.server.life.MapleMonster;
import org.extalia.server.life.MapleMonsterStats;
...
import org.extalia.tools.packet.MobPacket;
import org.extalia.tools.packet.SkillPacket;
...
//              ");
                ...
                //921170011
                if (!GameConstants.사출기(attack.skill) || attack.targets > 0 && player.getMapId() == 921170011 || attack.targets > 0 && player.getMapId() == 921170004) {
                    if (attack.targets > 0 && player.getKeyValue(99999, "tripling") > 0
                            ...
                            || attack.targets > 0 && player.getMapId() == 921170011 || attack.targets > 0 && player.getMapId() == 921170004 || attack.targets > 0 && attack.skill != 1311020 && player.getBuffedEffect(SecondaryStat.TryflingWarm) != null && !GameConstants.isTryFling(attack.skill) && attack.skill != 400031031 && attack.skill != 400031001 && attack.skill != 13111020 && attack.skill != 13121054 && attack.skill != 13101022 && attack.skill != 13110022 && attack.skill != 13120003 && attack.skill != 13111020 && attack.skill != 400001018 && attack.targets > 0) {
                        int skillid = 0;
                        if (player.getKeyValue(99999, "tripling") > 0 || player.getMapId() == 921170004 || player.getMapId() == 921170011 || player.getKeyValue(1234, "ww_whim") > 0 || player.getSkillLevel(SkillFactory.getSkill(13120003)) > 0) {
                            skillid = 13120003;
        ...
        //칼리
        if (MapleSkillManager.isKhaliVoydSkills(attack.skill) && monster != null) {
        ...
        if ( MapleSkillManager.isKhaliAttackSkills(attack.skill) && attack.targets > 0 && System.currentTimeMillis() - player.lastAstraTime >= 14000){
            player.lastAstraTime = System.currentTimeMillis();
            player.getClient().getSession().writeAndFlush((Object) CField.getLightOfCurigi(400041087));
        }
        ...
        for (AttackPair oned : attack.allDamage) {
            ...
            if (!GameConstants.사출기(attack.skill) || player.getMapId() == 921170004 || player.getMapId() == 921170011 ) {
                if (attack.targets > 0 && player.getKeyValue(99999, "tripling") > 0
                        ...
                        && attack.skill != 13111020
                        && attack.skill != 400001018
                    || player.getMapId() == 921170004 || player.getMapId() == 921170011 || attack.targets > 0 && attack.skill != 1311020 && player.getBuffedEffect(SecondaryStat.TryflingWarm) != null && !GameConstants.isTryFling(attack.skill) && attack.skill != 400031031 && attack.skill != 400031001 && attack.skill != 13111020 && attack.skill != 13121054 && attack.skill != 13101022 && attack.skill != 13110022 && attack.skill != 13120003 && attack.skill != 13111020 && attack.skill != 400001018 && attack.targets > 0) {
                    int skillid = 0;
                    ...
                    if (mist.getSourceSkill().getId() == 2111013) {
                        if (Rectanglebox1.contains(mist.getPosition()) || Rectanglebox2.contains(mist.getPosition())) {
                            if (mist.getStartTime() + 1500 < System.currentTimeMillis()) {
                                ...
                                org.extalia.server.Timer.MapTimer.getInstance().schedule(() -> {
