...
import org.extalia.client.BuddyList;
import org.extalia.client.BuddylistEntry;
...
import org.extalia.tools.CollectionUtil;
...
public class World {
        ...
        public static void updateParty(final int partyid, final PartyOperation operation, final MaplePartyCharacter target) {
            ...
            if (operation == PartyOperation.LEAVE || operation == PartyOperation.EXPEL) {
                ...
                if (chz > 0) {
                    ...
                    if (chr != null) {
                        chr.setParty(null);
                        chr.getClient().getSession().writeAndFlush((Object) CWvsContext.PartyPacket.updateParty(chr.getClient().getChannel(), party, operation, target, chr));
                    }
                }
            ...
            for (final MaplePartyCharacter partychar : party.getMembers()) {
                ...
                chr2.getClient().getSession().writeAndFlush((Object) CWvsContext.PartyPacket.updateParty(chr2.getClient().getChannel(), party, operation, target, chr2));
    ...
    public static class Guild {
        ...
        public static void changeEmblem(MapleCharacter chr, int affectedPlayers, MapleGuild mgs) {
            Broadcast.sendGuildPacket(affectedPlayers, CWvsContext.GuildPacket.guildEmblemChange(chr, (short) mgs.getLogoBG(), (byte) mgs.getLogoBGColor(), (short) mgs.getLogo(), (byte) mgs.getLogoColor()), -1, chr.getGuildId());
