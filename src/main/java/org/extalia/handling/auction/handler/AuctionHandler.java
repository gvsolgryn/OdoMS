package org.extalia.handling.auction.handler;
...
import org.extalia.handling.world.MapleMessengerCharacter;
...
import org.extalia.server.games.BattleReverse;
import org.extalia.server.games.OneCardGame;
...
import org.extalia.tools.packet.PacketHelper;
        ...
        switch (op) {
            case 0:
                ...
                for (Map.Entry<Integer, AuctionItem> itemz : items.entrySet()) {
                    ...
                    if ((auctionItem.getEndDate() < System.currentTimeMillis() || auctionItem.getState() >= 2) && ((
                            auctionItem.getState() == 2 && auctionItem.getBidUserId() == c.getPlayer().getId()) || ((auctionItem.getState() == 3 || auctionItem.getState() == 4) && auctionItem.getAccountId() == c.getAccID()))) {
                ...
                FileoutputUtil.log(FileoutputUtil.경매장입장로그, "[입장] 계정 번호 : " + c.getAccID() + " | 캐릭 번호 : " + c.getPlayer().getId() + " | 캐릭터 닉네임 : " + c.getPlayer().getName());
                break;
            case 10:
                ...
                FileoutputUtil.log(FileoutputUtil.경매장판매등록로그, "[아이템등록] 계정 번호 : " + c.getAccID() + " | 캐릭 번호 : " + c.getPlayer().getId() + " | 캐릭터 닉네임 : " + c.getPlayer().getName() + " | 아이템 이름 : " + ii.getName(auctionItem3.getItem().getItemId()) + " | 아이템 코드 : " + auctionItem3.getItem().getItemId() + " | 수량 " + auctionItem3.getItem().getQuantity() + " | 판매 메소 : " + l2);
                break;
            case 11:
                l1 = slea.readLong();
                k = slea.readInt();
                ...
                if (auctionItem5 != null && auctionItem5.getItem() != null && auctionItem5.getHistory() != null) {
                    ...
                    FileoutputUtil.log(FileoutputUtil.경매장판매등록로그, "[아이템재등록] 계정 번호 : " + c.getAccID() + " | 캐릭 번호 : " + c.getPlayer().getId() + " | 캐릭터 닉네임 : " + c.getPlayer().getName() + " | 아이템 이름 : " + ii.getName(auctionItem5.getItem().getItemId()) + " | 아이템 코드 : " + auctionItem5.getItem().getItemId() + " | 수량 " + auctionItem5.getItem().getQuantity() + " | 판매 메소 : " + auctionItem5.getDirectPrice());
                }
                break;
            case 12:
                ...
                if (aItem != null && aItem.getItem() != null) {
                    ...
                    FileoutputUtil.log(FileoutputUtil.경매장판매중지로그, "[판매중지] 계정 번호 : " + c.getAccID() + " | 캐릭 번호 : " + c.getPlayer().getId() + " | 캐릭터 닉네임 : " + c.getPlayer().getName() + " | 아이템 이름 : " + ii.getName(aItem.getItem().getItemId()) + " | 아이템 코드 : " + aItem.getItem().getItemId() + " | 갯수 : " + aItem.getItem().getQuantity());
                }
                break;
            case 20:
            case 21:
                ...
                if (auctionItem2 != null && auctionItem2.getItem() != null && auctionItem2.getItem().getQuantity() >= nCount) {
                    ...
                    if (item1.getQuantity() <= 0) {
                        ...
                        FileoutputUtil.log(FileoutputUtil.경매장구매로그, "[구입] 계정 번호 : " + c.getAccID() + " | 캐릭 번호 : " + c.getPlayer().getId() + " | 캐릭터 닉네임 : " + c.getPlayer().getName() + " | 아이템 이름 : " + ii.getName(auctionItem2.getItem().getItemId()) + " | 아이템 코드 : " + auctionItem2.getItem().getItemId() + " | 수량 " + auctionItem2.getItem().getQuantity() + " | 구매 메소 : " + nPrice + " | 해당 아이템 판매자 이름 : " + auctionItem2.getName());
                    } else {
            ...
            case 30:
                ...
                if (auctionItem4 != null && auctionItem4.getItem() != null && auctionItem4.getHistory() != null) {
                    ...
                    FileoutputUtil.log(FileoutputUtil.경매장대금수령로그, "[대금수령] 계정 번호 : " + c.getAccID() + " | 캐릭 번호 : " + c.getPlayer().getId() + " | 캐릭터 닉네임 : " + c.getPlayer().getName() + " | 아이템 이름 : " + ii.getName(auctionItem4.getItem().getItemId()) + " | 아이템 코드 : " + auctionItem4.getItem().getItemId() + " | 수량 " + auctionItem4.getItem().getQuantity() + " | 받은 메소 : " + (long) (l3 * 0.95D) + " | 해당 아이템 판매자 이름 : " + auctionItem4.getName());
                }
                break;
            case 31: { // 물품 반환
                //리시브를 그대로 보냄
            ...
            case 41:
                ...
                if (searchType == -1) {
                    for (AuctionItem auctionItem : items.values()) {
                        ...
                        if (name != null && (name.replaceAll(" ", "").contains(nameWithSpace) || name.replaceAll(" ", "").contains(nameWithoutSpace)) && ((
                                op == 40 && auctionItem.getState() == 0) || (op == 41 && (auctionItem.getState() == 3 || auctionItem.getState() == 8)))) {
                    ...
                    if (searchType <= 1) {
                        for (AuctionItem auctionItem : items.values()) {
                            if (auctionItem.getItem() != null && auctionItem.getItem().getType() == 1) {
                                ...
                                if (typeLimit && lvLimit && priceLimit && potentialLimit && (name.contains(nameWithSpace) || name.contains(nameWithoutSpace) || nameWithoutSpace.isEmpty()) &&
                                        equipOptionTypes() && ((op == 40 && auctionItem.getState() == 0) || (op == 41 && (auctionItem.getState() == 3 || auctionItem.getState() == 8)))) {
                                    searchItems.add(auctionItem);
                                }
                            }
                        }
                        ...
                        for (AuctionItem auctionItem : items.values()) {
                            ...
                            boolean lvLimit = (level >= lvMin && level <= lvMax);
                            boolean priceLimit = (auctionItem.getPrice() >= priceMin && auctionItem.getPrice() <= priceMax);
                            boolean typeLimit = typeLimit(searchType, itemType, itemSemiType, auctionItem.getItem().getItemId());
                ...
                FileoutputUtil.log(FileoutputUtil.경매장물품반환로그, "[검색] 계정 번호 : " + c.getAccID() + " | 캐릭 번호 : " + c.getPlayer().getId() + " | 캐릭터 닉네임 : " + c.getPlayer().getName() + " | 아이템 검색 : " + nameWithoutSpace);
                break;
            case 45:
                j = slea.readInt();
            ...
            case 51:
                ...
                for (AuctionItem auctionItem : items.values()) {
                    if (((auctionItem.getState() == 2 || auctionItem.getState() == 7) && auctionItem.getBidUserId() == c.getPlayer().getId()) || (auctionItem.getState() != 7 && auctionItem.getState() >= 3 && auctionItem.getAccountId() == c.getAccID())) {
