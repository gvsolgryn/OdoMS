...
import org.extalia.server.events.MapleEvent;
import org.extalia.server.events.MapleEventType;
import org.extalia.server.games.ColorInvitationCard;
...
public abstract class AbstractPlayerInteraction {
  ...
  public final void MakePmdrItem2(int itemid, int count) {
    ...
    c.getPlayer().setKeyValue(800023, "indiepmer2", String.valueOf((c.getPlayer().getKeyValue(800023, "indiepmer2")) + count));
  ...
  public final void MakePmdrItem3(int itemid, int count) {
    ...
    c.getPlayer().setKeyValue(800023, "indiepmer3", String.valueOf((c.getPlayer().getKeyValue(800023, "indiepmer3")) + count));
