...
import org.extalia.client.MapleTrait.MapleTraitType;
...
import org.extalia.handling.channel.handler.PsychicGrabEntry;
import org.extalia.handling.world.buddy.MapleBuddyType;
import org.extalia.handling.world.party.MapleParty;
import org.extalia.handling.world.party.MaplePartyCharacter;
import org.extalia.handling.world.party.MaplePartyType;
import org.extalia.handling.world.party.PartyOperation;
import org.extalia.handling.world.World;
import org.extalia.handling.world.guild.*;
import org.extalia.server.MapleItemInformationProvider;
...
import org.extalia.server.enchant.EquipmentEnchant;
import org.extalia.server.enchant.EquipmentScroll;
import org.extalia.server.enchant.StarForceStats;
import org.extalia.server.life.MapleMonster;
import org.extalia.server.life.MobSkill;
import org.extalia.server.life.PlayerNPC;
import org.extalia.server.maps.MapleMist;
import org.extalia.server.marriage.MarriageDataEntry;
    ...
    public static class BuffPacket {
        ...
        public static byte[] giveBuff(Map<SecondaryStat, Pair<Integer, Integer>> statups, SecondaryStatEffect effect, MapleCharacter chr) {
            ...
            for (Pair<SecondaryStat, Pair<Integer, Integer>> stat : newstatups) {
                if (!((SecondaryStat) stat.getLeft()).canStack() && !((SecondaryStat) stat.getLeft()).isSpecialBuff() && !statups.containsKey(SecondaryStat.PinkbeanRollingGrade)) {
...
//            }
        ...
        public static byte[] giveDisease(Map<SecondaryStat, Pair<Integer, Integer>> statups, MobSkill skill, MapleCharacter chr) {
            ...
            mplew.write(true);
            mplew.write(true);
            for (Entry entry : statups.entrySet()) {
    ...
    public static class InfoPacket {
        ...
        public static byte[] AcceptQuest(int questid, int npcid) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.ACCEPT_QUEST.getValue());
            mplew.write(11);
            mplew.writeInt(questid);
        ...
        public static byte[] GainEXP_Monster(MapleCharacter chr, long gain, boolean white, long flag, int eventBonusExp, int weddingExp, int partyExp, int itemEquipExp, int pcExp, int rainbowWeekExp, int boomupExp, int portionExp, int skillExp, int buffExp, int restExp, int itemExp, int valueExp, long bonusExp, long bloodExp, int iceExp, Pair<Integer, Integer> burningExp, int hpLiskExp, int fieldBonusExp, int eventBonusExp2, int fieldBonusExp2) {
            ...
            if ((flag & 0x1L) != 0L) {
                packet.writeLong(eventBonusExp);
            }
            if ((flag & 0x4L) != 0L) {
                byte a = 1;
                packet.write(a);
            ...
            if ((flag & 0x10L) != 0L) {
                packet.writeLong(weddingExp);
            }
            if ((flag & 0x20L) != 0L) {
                packet.writeLong(partyExp);
            }
            if ((flag & 0x40L) != 0L) {
                packet.writeLong(itemEquipExp);
            }
            if ((flag & 0x80L) != 0L) {
                packet.writeLong(pcExp);
            }
            if ((flag & 0x100L) != 0L) {
                packet.writeLong(rainbowWeekExp);
            }
            if ((flag & 0x200L) != 0L) {
                packet.writeLong(boomupExp);
            }
            if ((flag & 0x400L) != 0L) {
                packet.writeLong(portionExp);
            }
            if ((flag & 0x800L) != 0L) {
                packet.writeLong(skillExp);
            }
            if ((flag & 0x1000L) != 0L) {
                packet.writeLong(buffExp);
            }
            if ((flag & 0x2000L) != 0L) {
                packet.writeLong(restExp);
            }
            if ((flag & 0x4000L) != 0L) {
                packet.writeLong(itemExp);
            }
            if ((flag & 0x10000L) != 0L) {
                packet.writeLong(14);
            }
            if ((flag & 0x20000L) != 0L) {
                packet.writeLong(valueExp);
            }
            if ((flag & 0x40000L) != 0L) {
                packet.writeLong(16);
            }
            if ((flag & 0x80000L) != 0L) {
                packet.writeLong(bonusExp);
            }
            if ((flag & 0x100000L) != 0L) {
                packet.writeLong(bloodExp);
            }
            if ((flag & 0x200000L) != 0L) {
                packet.writeLong(iceExp);
            }
            if ((flag & 0x400000L) != 0L) {
                packet.writeLong(((Integer) burningExp.left).intValue());
                packet.writeInt(((Integer) burningExp.right).intValue());
            }
            if ((flag & 0x800000L) != 0L) {
                packet.writeLong(hpLiskExp);
            }
            if ((flag & 0x1000000L) != 0L) {
                packet.writeLong(fieldBonusExp);
            }
            if ((flag & 0x2000000L) != 0L) {
                packet.writeLong(23);
            }
            if ((flag & 0x4000000L) != 0L) {
                packet.writeLong(eventBonusExp2);
            }
            if ((flag & 0x8000000L) != 0L) {
                packet.writeLong(25);
            }
            if ((flag & 0x10000000L) != 0L) {
                packet.writeLong(fieldBonusExp2);
            }
    ...
    public static class GuildPacket {
        ...
        public static byte[] requestGuild(MapleGuild g, MapleCharacter chr) {
            ...
            mplew.writeShort(g.avergeMemberLevel());
            mplew.write(0);
        ...
        public static byte[] showGuildInfo(MapleCharacter c) {
            ...
            mplew.write(MapleGuildType.showInfo.getType());
        ...
        public static void getGuildInfo(MaplePacketLittleEndianWriter mplew, MapleGuild guild) {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                mplew.writeInt(i > 5 ? 0x400 : guild.getRankRole(i));
            }
            ...
            mplew.writeInt(guild.getFame());
            mplew.writeInt(guild.getFame());
            mplew.writeInt((guild.getAllianceId() > 0) ? guild.getAllianceId() : 0);
            mplew.write(guild.getLevel());
            mplew.writeInt(guild.getGP());
            mplew.writeInt(guild.getBeforeAttance());
            mplew.writeInt(GameConstants.getCurrentDateYesterday());
            ...
            for (MapleGuildSkill mapleGuildSkill : guild.getSkills()) {
                mplew.writeInt(mapleGuildSkill.skillID);
                mplew.writeShort(mapleGuildSkill.level);
                mplew.writeLong(PacketHelper.getTime(mapleGuildSkill.timestamp));
                mplew.writeMapleAsciiString(mapleGuildSkill.purchaser);
                mplew.writeMapleAsciiString(mapleGuildSkill.activator);
            }
            ...
            if (size > 0) {
                mplew.write(guild.getCustomEmblem());
            }
        ...
        public static byte[] addRegisterRequest(MapleGuildCharacter mgc) { //ok
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(78); //-10 355 362 +0 ok
            mplew.writeInt(mgc.getGuildId());
            mplew.writeInt(mgc.getId());
        ...
        public static byte[] guildContribution(int gid, int cid, int c) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(130); // 362 +1 ok
            mplew.writeInt(gid);
            mplew.writeInt(cid);
            mplew.writeInt(c);
            mplew.writeInt(Math.min(c, 5000));
        ...
        public static byte[] genericGuildMessage(int code) {
            ...
            if (code == 5 || code == 103 || code == 104 || code == 100 || code == 101 || code == 102) {
                mplew.writeMapleAsciiString("");
            }
            return mplew.getPacket();
        }
        ...
        public static byte[] RecruitmentGuild(MapleCharacter chr) {
            ...
            mplew.write(0);
            mplew.writeInt(0);
            mplew.writeInt(World.Guild.getGuilds().size());
            ...
            for (MapleGuild guild : World.Guild.getGuilds()) {
                ...
                mplew.writeShort(guild.avergeMemberLevel());
                mplew.write((guild.getRequest(chr.getId()) != null) ? 0 : 1);
                mplew.writeLong(0L);
                mplew.write(1);
                mplew.writeMapleAsciiString(guild.getNotice());
                mplew.writeInt(0);
        ...
        public static byte[] RequestListGuild(List<MapleGuild> g) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(188); //355 -> 362 +1 188
            mplew.writeInt(g.size());

            for (MapleGuild guild : g) {
                mplew.writeInt(guild.getId());
                mplew.write(guild.getLevel());
                mplew.writeMapleAsciiString(guild.getName());
                mplew.writeMapleAsciiString(guild.getLeaderName());
        ...
        public static byte[] showSearchGuildInfo(MapleCharacter chr, List<MapleGuild> gss, String text, byte mode, int option) {
            ...
            for (MapleGuild gs : gss) {
                ...
                mplew.write((gs.getRequest(chr.getId()) != null) ? 0 : 1);
                mplew.writeLong(0L);
                mplew.write(1);
        ...
        public static byte[] updateGP(int gid, int contribution, int GP, int glevel) { //ok
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(152); //355 -> 362 +1 ok
            mplew.writeInt(gid);
            mplew.writeInt(contribution);
            mplew.writeInt(glevel);
            mplew.writeLong(GP);
            return mplew.getPacket();
        }
        ...
        public static byte[] guildAattendance(MapleGuild guild, MapleCharacter chr) { //ok
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(183); //355 -> 362 +1 ok
            mplew.writeInt(guild.getId());
            mplew.writeInt(chr.getId());
            mplew.writeInt(GameConstants.getCurrentDateday());
            return mplew.getPacket();
        }
    }

    public static class PartyPacket {
        public static byte[] partyCreated(MapleParty party, MapleCharacter chr) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.PARTY_OPERATION.getValue());
            mplew.write(MaplePartyType.Created.getType());
            ...
            addPartyStatus(chr.getPlayer(),-1, World.Party.getParty(party.getId()), mplew); //if exped, send 0, if not then skip
            return mplew.getPacket();
        }
        ...
        public static void addPartyStatus(MapleCharacter chr, int forchannel, MapleParty party, MaplePacketLittleEndianWriter lew) {
            addPartyStatus(chr, forchannel, party, lew, false, false, (byte) 0);
        }

        public static void addPartyStatus(MapleCharacter chr, int forchannel, MapleParty party, MaplePacketLittleEndianWriter mplew, boolean leaving, boolean exped, byte type) {
            /*
             *  0 : None
             *  1 : 파티 가입
             *  2 : 접속 상태
            ...
            if (type > 0) { // 파티 생성을 제외하고..
                ...
                for (MaplePartyCharacter partychar : partymembers) {
                    mplew.writeInt(partychar.getChannel() == forchannel ? partychar.getMapid() : partychar.getChannel());  //상대방 위치 (채널이 다를시 채널로)
                }
                for (MaplePartyCharacter partychar : partymembers) {
                    mplew.writeInt(partychar.getChannel() == forchannel && !leaving ? partychar.getDoorTown() : 0);
                    mplew.writeInt(partychar.getChannel() == forchannel && !leaving ? partychar.getDoorTarget() : 0);
                    mplew.writeInt(partychar.getChannel() == forchannel && !leaving ? partychar.getDoorSkill() : 0);
                    mplew.writeInt(partychar.getChannel() == forchannel && !leaving ? partychar.getDoorPosition().x : 0);
                    mplew.writeInt(partychar.getChannel() == forchannel && !leaving ? partychar.getDoorPosition().y : 0);
                }
                mplew.write(0);
            }
            mplew.writeMapleAsciiString(party.getPatryTitle());
            mplew.write(party.getVisible()); // (파티 종류) 1 = 전체, 0 = 비공개
            mplew.write(party.getPartyDrop()); // (습득 권한) 0 = 전체, 1 = 파티장
            mplew.writeInt(-1);
            mplew.writeInt(type > 0 ? -1 : party.getLeader().getId());
        }

        public static byte[] updateParty(int forChannel, MapleParty party, PartyOperation op, MaplePartyCharacter target, MapleCharacter chr) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.PARTY_OPERATION.getValue());
            ...
            switch (op) {
                ...
                case EXPEL: // 강퇴
                case LEAVE: { // 탈퇴
                    mplew.write(MaplePartyType.Disband.getType());
                    mplew.writeInt(op == PartyOperation.DISBAND ? chr.getId() : target.getId());
                    ...
                    if (op != PartyOperation.DISBAND) {
                        mplew.writeInt(party.getId());
                        mplew.write(0);
                        addPartyStatus(target.getPlayer(), forChannel, party, mplew, false, false,  (byte) 3);
                    }
                    break;
                }
                case JOIN: { // 파티가입
                    mplew.write(MaplePartyType.Join.getType());
                    mplew.writeMapleAsciiString(target.getName());
                    mplew.writeInt(0);
                    mplew.write(0);
                    mplew.writeInt(party.getId());
                    mplew.write(0);
                    addPartyStatus(chr.getPlayer(), forChannel, party, mplew, false, false,  (byte) 1);
                    break;
                }
                case SILENT_UPDATE:
                case LOG_ONOFF: {
                    mplew.write(MaplePartyType.LogState.getType());
                    mplew.write(1);
                    mplew.writeInt(party.getId());
                    mplew.write(0);
                    addPartyStatus(chr.getPlayer(), forChannel, party, mplew, false, false,  (byte) 2);
                    break;
                }
                case CHANGE_LEADER:
                case CHANGE_LEADER_DC: {
                    mplew.write(MaplePartyType.LeaderUpdate.getType());
                    mplew.writeInt(target.getId());
                    mplew.write(op == PartyOperation.CHANGE_LEADER_DC ? 1 : 0);
                    break;
                }
                case CHANGE_PARTY_TITLE: { // 파티 제목 변경
                    mplew.write(MaplePartyType.PartyTitle.getType());
                    mplew.writeMapleAsciiString(party.getPatryTitle());
                    mplew.write(party.getVisible());
                    mplew.write(party.getPartyDrop());
                    break;
                }
            }
            return mplew.getPacket();
    ...
    public static class BuddylistPacket {
        ...
        public static byte[] updateBuddylist(Collection<BuddylistEntry> buddylist, BuddylistEntry buddies, byte op) {
            ...
            if (op == 21) { // 1149 1++
                ...
                mplew.write(5);//buddies.isVisible() ? 0 : 7);
        ...
        public static byte[] buddyAddMessage(String charname) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.BUDDYLIST.getValue());
            mplew.write(MapleBuddyType.addBuddy.getType());
            mplew.writeMapleAsciiString(charname);
            return mplew.getPacket();
        }
        ...
        public static byte[] requestBuddylistAdd(int cidFrom, int accId, String nameFrom, int levelFrom, int jobFrom, MapleClient c, String groupName, String memo) {
            ...
            mplew.writeInt(accId);
            mplew.writeAsciiString(nameFrom, 13);
            mplew.writeAsciiString(memo, 261);
            return mplew.getPacket();
        }
        ...
        for (final Entry<MapleStat, Long> statupdate : mystats.entrySet()) {
            switch (statupdate.getKey()) {
                ...
                case VIRTUE:
                    mplew.writeLong((statupdate.getValue()).longValue());
                    break;
                case RECOVERY_POTION_WITH_HP:
                case RECOVERY_POTION_WITH_MP:
                    ...
                    break;
                case RECOVERY_POTION_WITH_HPMP:
                    mplew.writeInt((statupdate.getValue().intValue()));
                    mplew.writeInt((statupdate.getValue().intValue()));
                    mplew.writeLong(0);
                    mplew.writeLong(0);
    ...
    public static byte[] charInfo(MapleCharacter chr, boolean isSelf) {
        ...
        long dojo = chr.getPlayer().getKeyValue(3, "dojo");
        mplew.writeInt(dojo); // 무릉도장 층

        mplew.writeMapleAsciiString(""); // 날짜

        mplew.writeInt(chr.getAllUnion()); // 유니온 레벨
    ...
    public static byte[] MatrixSkillMulti(MapleCharacter chr, int skillid, int level, int unk1, int unk2, int bullet, boolean data, List<Integer> datas, List<MatrixSkill> skills, byte dir) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        if (data) {
            ...
            mplew.write(((Integer) datas.get(5)).intValue()); // ida 1149
            mplew.writeInt(((Integer) datas.get(6)).intValue());
            mplew.write(((Integer) datas.get(7)).intValue());
        }
        switch (skillid) {
            case 154121001: {
                mplew.writeInt((datas.get(2)).intValue()); // 1149++
                mplew.writeInt((datas.get(3)).intValue()); // 1149++
                mplew.write((datas.get(5)).intValue()); // 방향
                break;
            }
        }
        mplew.writeInt(skills.size());
    ...
    public static byte[] setBossReward(MapleCharacter player) {
        ...
        for (int i = 0; i < items.size(); i++) {
            mplew.writeLong(((Item) items.get(i)).getReward().getObjectId());
            mplew.writeInt(((Item) items.get(i)).getReward().getMobId());
            mplew.writeInt(((Item) items.get(i)).getReward().getPartyId());
            mplew.writeInt(((Item) items.get(i)).getReward().getPrice());
            mplew.writeInt(0);
            mplew.writeLong(0);
