...
public class NPCSpawningCommands implements Command {
    ...
    public void execute(MapleClient c, String[] splitted) throws Exception, IllegalCommandSyntaxException {
        ...
        if (splitted[0].equals("!엔피시")) {
            ...
            if (npc != null && !npc.getName().equals("MISSINGNO")) {
                ...
                c.getPlayer().dropMessage(5, npc.getObjectId() + "");
            ...
            c.getPlayer().dropMessage(6, "CY: " + (pos.y + 2) + " | RX0: " + (pos.x + 50) + " | RX1: " + (pos.x - 50)
                    + " | FH: " + c.getPlayer().getMap().getFootholds().findMaple(pos).getId());
            ...
            try {
                ...
                ps.setInt(4, c.getPlayer().getPosition().y + 2);
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{new CommandDefinition("엔피시", "<엔피시ID>", "현재 위치에 해당 ID의 엔피시를 소환합니다.", 5),
