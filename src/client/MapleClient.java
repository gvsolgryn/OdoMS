...
public class MapleClient {
    ...
    public int login(String login, String pwd, String mac, boolean weblogin, boolean ipMacBanned) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                this.discord = rs.getString("discordID");
    ...
    public final void removalTask(boolean shutdown) {
        try {
            ...
            FileoutputUtil.outputFileError("Log/Log_AccountStuck.rtf", e);
        }
    }
    ...
    public static long ExpCheck(String name) {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            con = DatabaseConnection.getConnection();
            ps = con.prepareStatement("SELECT exp FROM characters WHERE name = ?");
            ps.setString(1, name);
            rs = ps.executeQuery();
            if (rs.next()) {
            ...
            try {
                ...
                System.err.println("Error closing database resources" + e);
            }
        }
