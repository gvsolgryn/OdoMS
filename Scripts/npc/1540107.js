...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        trade = "#fs11#"+검정+"저는 #fc0xFF000087#[HEINZ]#k "+검정+"#b의자 판매#k"+검정+"를 담당하고 있는 라이언.D라고 합니다."
        trade += "\r\n선택하신 의자 하나 당 #r#z4319999# 10개#k"+검정+"로 구매가 가능합니다.\r\n\r\n";
        trade += "현재 보유중인 #d#z4319999##k 갯수 : #e#r"+leaf+"#k개#n\r\n"
        ...
        var itemsArray = getArray(menuSelect);
        if (cm.haveItem(4319999, 10) && cm.canHold(itemsArray[select])) {
            cm.gainItem(4319999, -10);
