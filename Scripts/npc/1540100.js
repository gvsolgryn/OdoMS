...
if (status == 0) {
    var a = "#fs11##fc0xFFFF3366##h0# #fc0xFF000000#님의 홍보 포인트 : #fc0xFFFF3366#" + cm.getPlayer().getHPoint() + " P#k#n\r\n";
    for (var i = 0; i < itmelist.length; i++) {
        a += "#L" + i + "##i" + itmelist[i][0] + "# #d#z" + itmelist[i][0] + "##l#k#r " + itmelist[i][2] + " 개\r\n               #fc0xFF000000#홍보 포인트#k #e#fc0xFFFF3366#" + itmelist[i][1] + " P#k#n\r\n";
    }
 /*   for (var i = 18; i < 24; i++) {
        a += "#L" + i + "##i" + itmelist[i][0] + "# #d#z" + itmelist[i][0] + "##l#k#r " + itmelist[i][2] + " 개\r\n               #fc0xFF000000#홍보 포인트#fc0xFF000000# #e#fc0xFFFF3366#" + itmelist[i][1] + " P#k#n\r\n               #r \r\n";
    }
    ...
    cm.sendOk("#fs11##b홍보 포인트#k 가 부족합니다.");
    ...
    if (sel >= 0 && sel <= itmelist.length) {
        if (cm.getPlayer().getHPoint() >= itmelist[sel][1] * count) {
            if (cm.canHold(itmelist[7][0]) || cm.canHold(itmelist[8][0])) {
                cm.sendOk("#b홍보 포인트#k 로 #i" + itmelist[sel][0] + "# #r " + itmelist[sel][2] * count + " 개#k 를 구입 하셨습니다.");
                cm.dispose();
            }
