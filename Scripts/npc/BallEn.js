...
function action(mode, type, selection) {
    ...
    if (St == 0) {
        말 = "#fs11##r#i"+itemid+"##z"+itemid+"##fc0xFF000000#을 이용해\r\n모든 업그레이드 된 장비에 #bP마일리지로 특별 추가옵션#fc0xFF000000#을 부여할 수 있습니다.\r\n\r\n";
        말 += "#L0# #b추가옵션 부여하기#k#l";
        cm.sendSimple(말);
    } else if (St == 1) {
