...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        ab = str.split("");
        말 = "#fs11#예티, #b#e예티 육성 완료 보상#k#n 준다!\r\n#r#e당신 주의해라! 메이플ID당 1번만 받을 수 있다!#n#k\r\n\r\n#b"
        말 += "#L0#200레벨 보상 받기\r\n"
        말 += "#L1#210레벨 보상 받기\r\n"
        말 += "#L2#220레벨 보상 받기\r\n"
        말 += "#L3#230레벨 보상 받기\r\n"
        말 += "#L4#240레벨 보상 받기\r\n"
        말 += "#L5#250레벨 보상 받기\r\n"
        cm.sendSimpleS(말, 0x04, 9062505);
    } else if (status == 1) {
        sel = selection;
        말 = "";
        if (sel == 0) {
            말 += "예티, #b#e예티가 준비한 보상#k#n 준다!\r\n\r\n"
            ...
            말 += "예티, #b#e예티가 준비한 보상#k#n 준다!\r\n\r\n"
            말 += "#i3700682# #b#z3700682##k#k\r\n"
            말 += "#i2433913# #b#z2433913##k#k\r\n"
            말 += "#i5062006# #b#z5062006##k #r30개#k\r\n"
            말 += "#i2049376# #b#z2049376##k #r1개#k\r\n"
        ...
        cm.sendYesNoS(말, 0x04, 9062505);
    } else if (status == 2) {
        if (ab[sel] == 1) {
            cm.sendOkS("당신! 이미 #b#e보상#k#n을 받았다!!", 4, 9062505);
            cm.dispose();
            return;
        }
        if (!GameConstants.isYeti(cm.getPlayer().getJob())) {
            cm.sendOkS("당신, 보상은 #b#e예티#k#n 캐릭터로만 받아갈 수 있다!!\r\n\r\n#r※보상 아이템은 #e메이플 보관함#n에 지급됩니다.#k", 4, 9062505);
            cm.dispose();
            return;
        }
        if ((base + (sel * 10)) > cm.getPlayer().getLevel()) {
            cm.sendOkS("당신, #b#e레벨#k#n 부족하다! 예티 못준다!!\r\n\r\n#r※ 해당 보상을 받으려면 #e"+(base + (sel * 10))+" 레벨#n이 되어야 합니다.", 4, 9062505);
            cm.dispose();
            return;
        }
        ab[sel] = 1;
        ...
        cm.sendOkS("당신, #r#e메이플 보관함#n#k에 지급했다! 예티 확인했다!!", 4, 9062505);
        if (sel == 0) {
            ...
            cm.getPlayer().gainCabinetItem(3700682, 1);
            cm.getPlayer().gainCabinetItem(2433913, 1);
            cm.getPlayer().gainCabinetItem(5062006, 30);
            cm.getPlayer().gainCabinetItem(2049376, 1);
