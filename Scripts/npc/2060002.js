...
var items = [
   {'itemid' : 3700511, 'qty' : 1, 'allstat' : 0, 'atk' : 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
   'recipes' : [[3700510, 1], [4310320, 5000]], 'price' : 500000000, 'chance' : 100, //재료, 비용, 확률
   'fail' : [[3700511, 1]] //실패시 지급되는 아이템
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      ...
      if (item['price'] > 0)
         msg += "#i5200002#"+item['price']+" 메소 (5억)"+enter;
