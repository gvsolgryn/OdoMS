...
var items = [
   {'itemid' : 3700514, 'qty' : 1, 'allstat' : 0, 'atk' : 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
   'recipes' : [[3700513, 1], [4310320, 30000]], 'price' : 5000000000, 'chance' : 100, //재료, 비용, 확률
   'fail' : [[3700514, 1]] //실패시 지급되는 아이템
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "영웅이 되고 싶으시다고요? 맡겨만 주세요!!"+enter;
      ...
      msg += enter;
      msg += "#fs12##k선택하신 아이템을 제작하기 위한 재료입니다.#fs11##d"+enter+enter;
      ...
      if (item['price'] > 0)
         msg += "#i5200002#"+item['price']+" 메소 (50억)"+enter;
