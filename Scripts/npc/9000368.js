...
function action(mode, type, selection) {
    ...
    */
    ...
    questlist = [
        ...
        [4036491, "mob", 500, false, 210, 310030300], //부품
        [4033172, "mob", 500, false, 220, 410000113], //기억의조각
        //[4036491, "item", 20, false, 200, -1],// 정체모를부품
        //[4033172, "item", 20, false, 210, -1],기억의조각
    ...
    */
    ...
    if (status == 0) {
        ...
        말 = "#fc0xFF6600CC##e#fs11#[로얄 스토리] 육성 다이어리#n#k\r\n\r\n";
        말 += "#b" + questlist.length + " 개#k 의 #b#e[로얄 스토리] 육성 다이어리#k#n를 완성하고 보상을 받아가세요.\r\n#r#e#fs12#[ 퀘스트를 클릭하면 해당 맵으로 이동합니다. ]#k#fs11##n\r\n";
        말 += "#b * 모든 다이어리 완료보상 : #b#i4310248##z4310248# #r2000개#k\r\n";
