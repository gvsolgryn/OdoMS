...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        var msg = "#fs12##fc0xFF990033##e[HEINZ]#n#fc0xFF000000#의 각종 랭킹을 확인할 수 있는 게시판입니다.#b" + enter + enter;
        msg += "#L1# 레벨 랭킹" + enter;
        msg += "#L3# 계승자 랭킹" + enter;
        msg += "#L2# 메소 랭킹" + enter;
        msg += "#L4# 길드 랭킹" + enter;
        ...
        switch (sel) {
            ...
            case 2:
                ...
                break;
            case 3:
                cm.sendOk(getRank("SELECT * FROM characters WHERE `fame` > 0 AND `gm` = 0 ORDER BY `fame` DESC LIMIT ", "fame", "계승자", 10));
                cm.dispose();
                break;
            case 4:
