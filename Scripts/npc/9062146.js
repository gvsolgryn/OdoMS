...
var reward = [ 
	...
	[ 130, 130, 2437573, 1, 2437575, 1 ],
	[ 150, 150, 4021022, 15, 4021022, 40 ],
	[ 170, 170, 4031013, 15, 4031013, 40 ],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	var msg = "#fs11##fc0xFF000000#현재 #fc0xFF6600CC##h0# #fc0xFF000000#님의 성장패스 레벨 :#fc0xFFFF3300# " + (cm.getPlayer().getKeyValue(100592, "point") + 1); + "\r\n";
msg += "   \r\n#r성장패스는 일일 퀘스트를 통해 레벨업 할 수 있습니다.\r\n";
	msg += "#Cgray#――――――――――――――――――――――――――――――――――――――――";
	msg += "#L1##b성장패스 보상을 수령하겠습니다.\r\n";
	msg += "#L2#성장패스의 보상이 궁금합니다.\r\n";
	
	cm.sendSimple(msg);
//cm.getPlayer().setKeyValue(100592, "point", "" + (cm.getPlayer().getKeyValue(100592, "point") + 4));
    } else if (status == 1) {
	if (selection == 1) {
		var list = "#fs11##fc0xFF000000#자네가 받을 수 있는 보상은 아래와 같다네.#b\r\n";
		var level = (cm.getPlayer().getKeyValue(100592, "point") + 1);
