...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var choose = "#fs11##b[HEINZ]#k" + 검정 + "에 온 것을 환영하네! \r\n\r\n";
        choose += "#fUI/UIWindow2.img/UtilDlgEx/list4#\r\n#fs12#";
        choose += "#L0#" + 하늘 + "[HEINZ] 서버 규칙 및 필수 안내" + 퀘스트 + "#l\r\n";
        //choose += "#fs12##L1#" + 하늘 + "[HEINZ] HEINZ 칭호 받기" + 퀘스트 + "#l\r\n";
        //choose += "#fs12##L2##d[HEINZ] 추천인 설명 및 상점#l\r\n";
        //choose += "#fs12##L3##d[HEINZ] 데일리기프트 상점#l\r\n";
        //choose += "#fs12##L4##d[HEINZ] HEINZ로 이동하기#l\r\n";
        cm.sendSimple(choose);

    } else if (status == 1) {
        seld = selection;
        if (selection == 0) {
            말 = "#fs11##bHEINZ#k에 온 #e#h ##n용사여, 어떤게 궁금한가?#k\r\n"
            말 += "#fc0xFFD5D5D5#─────────────────────────────#k#l\r\n";
            말 += "#L0##fs11##b[HEINZ] 배율이 궁금해요.\r\n"
            ...
            var choose = "#fs11#"+검정+" 칭호를 지급 했다네. 더 좋은 칭호를 얻기 위해 #fc0xFF050099#HEINZ#k"+검정+"에서 열심히 즐겨보게나!\r\n";
            ...
            var choose = "#fs11#"+검정+"#bHEINZ#k"+검정+"에서 느낀 즐거움을 다른 사람에게도 나눠주게!\r\n";
        ...
        if (selection == 0) {
            ...
            말 +="추천은 #r계정당 1회#k"+검정+"만 가능하고 추천을 등록하면 HEINZ에서 지급해주는 #b특별한 아이템#k"+검정+"을 받을 수 있지. 크크\r\n"
            말 +="자네가 추천을 받게 된다면 #r추천인 포인트가 1#k"+검정+"씩 오른다네.\r\n"
            말 +="받은 포인트로 상점에서 #b다양한 아이템#k"+검정+"을 구매할 수 있으니 HEINZ 서버를 널리 알려주게. 크크크."
            cm.sendOk(말);
            cm.dispose();
        }
    } else if (status == 3) {
