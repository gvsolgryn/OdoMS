...
function action(mode, type, sel) {
	...
	if (status == 0) {
		msg += "어서오세요 #h0#님!\r\n무엇을 이용하시겠어요?\r\n";
		msg += "#L0# #b검색 성형 헤어를 이용하겠습니다.\r\n#l";
		msg += "#L2# 검색 캐시를 이용하겠습니다.#l\r\n";
		msg += "#L3# 캐릭터 컬러변경을 이용하겠습니다.#l\r\n";
		msg += "#L4# 성별변경 시스템를 이용하겠습니다.\r\n#l";
		//msg += "#L5# 안드로이드 관련 을 이용하겠습니다.\r\n#l";
		...
		if (sel == 0) {
			...
			msg += "#L21# 렌즈색 변경하기#l\r\n";
			msg += "#L22# 피부색 변경하기#l\r\n";
			msg += "#L23# 캐릭터 색상 변경하기#l\r\n";
			msg += "#L24# 캐릭터 색상 리셋하기#l\r\n";
			msg += "#L25# 믹스 렌즈/염색 구매하기#l\r\n";
			cm.sendSimple(msg);
		} else if (sel == 4) {
			isMaple = !cm.getPlayer().getGender() ? "#r여자#k" : "#b남자#k";
			cm.sendYesNo("성별을 " + isMaple + "로 변경하시겠습니까?");
			sel = 100;
		} else if (sel == 5) {
