...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendGetNumber(9401232, 말, leaf, 1, leaf);
    } else if (status == 1) {
        ...
        var text = "#fs11#정말로 #b#z4310006# " + count + "개#k를 정제할텐가?\r\n";
        var textadd = suc >= 20 ? "현재 정제 성공 확률 : #e" + suc + "#n% (#r최대 확률입니다!#n#k)" : "현재 정제 성공 확률 : #r#e" + suc + "#n%";
        cm.sendYesNoS(text + textadd, 0x04, 9401232);
    } else if (status == 2) {
        var givecount = 0;
        for (var i = 0; i < count; i++) {
        ...
        cm.sendOkS("#fs11#정제한 결과가 나왔다네.\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#b#i4310007# #z4310007# "+givecount+"개", 0x04, 9401232);
        cm.dispose();
    }
}