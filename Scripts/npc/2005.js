 ...
 */
 ...
 stealSkills[2] = [
     ...
     1211018, 1211010, 1211012, 1211013, 1211014, 1211011, //나이트
     1311011, 1311012, 1311015, //버서커
     2311004, 2311011, 2311002, 2311001, 2311003, 2311009, //프리스트
     2111002, 2111003, //불독
     2211002, 2211014, //썬콜
     3111013, //레인저
     3211011, 3211012, //저격수
 ...
 function action(mode, type, selection) {
     ...
     chat = '#fs11#'
     if (status == 0) {
         chat += '팬텀직업군만 사용가능한 스킬 훔치기 시스템입니다.'
         cm.sendSimple(chat)
     } else if (status == 1) {
         ...
         if (tupleSlotSkill == null || !tupleSlotSkill.right) {
             ...
             if (isreplaceSkill) {
                 ...
                 chat += SkillFactory.getSkillName(tupleSlotSkill.left) + '이(가) ' + enter
             }
