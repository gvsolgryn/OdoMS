...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		var chat = enter
		choose += "" + " 　　　   　　　　    #fUI/Basic.img/theblackcoin/35#닉스 컨텐츠 시스템#fUI/Basic.img/theblackcoin/35##l　\r\n";
        choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  뽑기 시스템  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
		choose += "#L0#" + 뎀스 +"" + 보라 + " 시드링 뽑기     #l#k";
        choose += "#L1#" + 뎀스 +"" + 보라 + " 라이딩 뽑기     #l#k";
        choose += "#L2#" + 뎀스 +"" + 보라 + " 의자 뽑기#l　\r\n\r\n";
		choose += "         #L3#" + 뎀스 +"" + 블루		+ " 데미지 스킨 뽑기      #l#k";
		choose += "#L4#" + 뎀스 +"" + 블루 + " 모루용 훈장 뽑기(점검중)#l　\r\n\r\n";
		choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  각종 컨텐츠  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
		choose += "#L5#" + 마라벨 +"" + 연파랑 + " 캐시템 모루     #l#k";
        choose += "#L6#" + 마라벨 +"" + 연파랑 + " 메소 도박장     #l#k";
        choose += "#L7#" + 마라벨 +"" + 연파랑 + " 무릉 도장#k\r\n\r\n";
		choose += "         #L8#" + 마라벨 +"" + 노랑 + " 미니게임 원카드       #l#k";
		choose += "#L9#" + 마라벨 +"" + 노랑 + " 어드벤처 드릴 #l　\r\n\r\n";
