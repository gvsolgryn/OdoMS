...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	if (cm.getPlayer().getLevel() >= 160 && cm.getPlayer().getMapId() == 993189100) {
