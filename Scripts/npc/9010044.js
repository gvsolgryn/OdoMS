...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		var chat = enter
		choose += "" + " 　　　　　　　　      #fUI/Basic.img/theblackcoin/35#닉스 편의 시스템#fUI/Basic.img/theblackcoin/35##l　\r\n";
        choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  도네이션 & 프로모션  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
		choose += "#L0#" + 의자 + " #fc0xFFF15F5F#후원 시스템     #l#k";
        choose += "#L1#" + 라이딩 + " #fc0xFFF15F5F#홍보 시스템#l　\r\n\r\n";
		choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 빠른 이용 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
        choose += "#L2#" + 집 + " #fc0xFFA566FF#아이템 창고     #l#k";
        choose += "#L3#" + 훈장 + " #fc0xFFA566FF#닉네임 변경     #l#k";
        choose += "#L4#" + 커플 + " #fc0xFFA566FF#각종 랭킹확인#l　\r\n\r\n";
		choose += "#L5#" + 결혼 + " #fc0xFFA566FF#코디 시스템     #l#k";
		choose += "#L17#" + 결혼 + " #fc0xFFA566FF#스킬 훔치기     #l#k";
        choose += "#L6#" + 마라벨 + " #fc0xFFA566FF#V매트릭스#l　\r\n\r\n";
		choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 특수 기능 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
		choose += "#L7#" + 무릉 + " #b잡템 버리기     #l#k";
		choose += "#L8#" + 네오젬 + " #b길드 시스템     #l#k";
		choose += "#L9#" + 포켓 + " #bA코어 교환#l　\r\n\r\n";
		choose += "#L10#" + 모루 + " #b추천인 기능     #l#k";
		choose += "#L11#" + 라이딩 + " #b데미지 체크     #l#k";
		choose += "#L12#" + 강화 + " #b물방울석 교환#l　\r\n\r\n";
		choose += "#L13#" + 펫 + " #b펫 분양받기     #l#k";
		choose += "#L15#" + 펫 + " #bS급 코어 교환     #l#k";
		choose += "#L14#" + 블랙스킬 + " #b자유 전직#l　\r\n\r\n";
		choose += "#L16#" + 펫 + " #b보스 물떡 교환     #l#k";
        ...
        if (selection == 0) {
            cm.dispose();
            cm.openNpc(9000210); //후원
        } else if (selection == 1) {
            cm.dispose();
            cm.openNpc(3001850); //홍보
        } else if (selection == 2) {
            cm.dispose();
            cm.openNpc(1002005); //아이템 창고
        } else if (selection == 3) {
            cm.dispose();
            cm.openNpc(9062010); //닉네임
        } else if (selection == 4) {
            cm.dispose();
            cm.openNpc(9076004); //랭킹
        } else if (selection == 5) {
            cm.dispose();
            cm.openNpc(9401408); //코디
		} else if (selection == 6) {
            cm.dispose();
            cm.openNpc(1540945); //5차 매트릭스
		} else if (selection == 7) {
            cm.dispose();
            cm.openNpc(1012121); //잡템 버리기
		} else if (selection == 8) {
            cm.dispose();
            cm.warp(200000301); //길드
		} else if (selection == 9) {
            cm.dispose();
