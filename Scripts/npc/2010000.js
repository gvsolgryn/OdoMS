...
function action(mode, type, selection) {
    ...
    if (status == 0) {
    if (cm.getPlayer().getMapId() == 993189100) {
        var john = "#fn나눔고딕 Extrabold##b찰리중사#k... 는어디있지.....\r\n\r\n";
    if (!cm.haveItem(4036162,1)) {
        ...
        cm.dispose();
            ...
            if (selection == 2 ) {
	cm.sendOk("#fn나눔고딕 Extrabold#역시 #b이지 중사#k 는 존재하지 않았군요..\r\n아쉽지만 어쩔수 없군요.\r\n이건 제 보답 입니다, 사양 말고 받도록 하세요.\r\n\\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n\r\n#i4310317# #b#z4310317##k #r200 개#k");
	cm.gainItem(4036162,-1);
	cm.gainItem(4310317, 200);
