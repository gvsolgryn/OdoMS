...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		for (i = 0; i < need.length; i++) {
			if (i != need.length - 1) msg += "#fs11##i"+need[i]['itemid']+"##z"+need[i]['itemid']+"# "+need[i]['qty']+"개와"+enter;
			else msg += "#fs11##i"+need[i]['itemid']+"##z"+need[i]['itemid']+"# "+need[i]['qty']+"개를 주신다면 조사에 큰 도움이 될겁니다.\r\n\r\n 대신 제가 가진 #b#z"+tocoin+"##k을 드리겠습니다."+enter;
		}
