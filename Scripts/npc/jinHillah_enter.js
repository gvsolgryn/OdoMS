...
var setting = [["Normal_JinHillah", 1, 450010500, 250], ["Hard_JinHillah", 1, 450010600, 250], ["Extreme_JinHillah", 1, 450010500, 250], ["Hell_JinHillah", 1, 450010500, 250]];
var name = ["노멀", "익스트림", "헬"];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        talk += "#L0##b진 힐라#k#r (레벨 250이상)#k#l\r\n";
        ...
        if (cm.getParty() == null) {
            ...
            cm.dispose();
            return;
        } else if (cm.getPlayerCount(450010500) >= 1 || cm.getPlayerCount(450010600) >= 1 ) {
...
//        } else
        ...
        if (!cm.isLevelAvailable(setting[st][3])) {
            ...
            talk += "#k#n님의 레벨이 부족합니다. 진 힐라 " + name[st] + "모드는 " + setting[st][3] + " 레벨 이상만 입장 가능합니다.";
