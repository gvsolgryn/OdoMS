...
var NumReward = [
	{'n' : 1, 'items' : [
				{'itemid' : 4310266, 'qty' : 500,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 4310237, 'qty' : 1000,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 4001716, 'qty' : 5,  'atk' : -1, 'allstat' : -1, 'select' : false},
				]
	},
	{'n' : 2, 'items' : [
				{'itemid' : 2438145, 'qty' : 1,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 4001716, 'qty' : 10,  'atk' : -1, 'allstat' : -1, 'select' : false},
				]
	},
	{'n' : 3, 'items' : [
				{'itemid' : 2430044, 'qty' : 1,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 4001716, 'qty' : 20,  'atk' : -1, 'allstat' : -1, 'select' : false},
				]
	},
	{'n' : 4, 'items' : [
				{'itemid' : 4310266, 'qty' : 2000,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 4310237, 'qty' : 3000,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 4001716, 'qty' : 50,  'atk' : -1, 'allstat' : -1, 'select' : false},
				]
	},
	{'n' : 5, 'items' : [
				{'itemid' : 4031227, 'qty' : 1000,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 4001716, 'qty' : 100,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 2430044, 'qty' : 1,  'atk' : -1, 'allstat' : -1, 'select' : false},
				]
	},
	{'n' : 6, 'items' : [
				{'itemid' : 4310308, 'qty' : 1000,  'atk' : -1, 'allstat' : -1, 'select' : false},
				{'itemid' : 2430044, 'qty' : 2,  'atk' : -1, 'allstat' : -1, 'select' : false},
				]
	},
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg += "#L5#서포트 포인트 상점을 이용하겠습니다."+enter;
                             //msg += "#L9#뱃지, 포켓 잠재능력 부여를 이용하겠습니다."+enter;
		//msg += "#L7#누적 등급 보상 수령하기"+enter;
