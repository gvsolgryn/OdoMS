...
var items = [
   ...
   },
   {
      ...
      'recipes': [[1143195, 1], [4319999, 5000]], 'price': 20000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1143196, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1143197, 'qty': 1, 'allstat': 300, 'atk': 300, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1143196, 1], [4319999, 10000]], 'price': 30000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1143197, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1143198, 'qty': 1, 'allstat': 500, 'atk': 500, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1143197, 1], [4319999, 15000], [4319997, 1000]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1143198, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1143199, 'qty': 1, 'allstat': 800, 'atk': 800, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1143198, 1], [4319999, 20000], [4319997, 1500]], 'price': 80000000000, 'chance': 100, //재료, 비용, 확률
