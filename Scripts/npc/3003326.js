...
var daily = [ // 첫번째
{'mobid' : 8644000, 'qty' : 1000, 't' : 1}, 
{'mobid' : 8644001, 'qty' : 1000, 't' : 1},
{'mobid' : 8644003, 'qty' : 1000, 't' : 1},
{'mobid' : 8644009, 'qty' : 1000, 't' : 1},
{'mobid' : 8644008, 'qty' : 1000, 't' : 1},
{'mobid' : 8644010, 'qty' : 1000, 't' : 1}, 
{'mobid' : 8644008, 'qty' : 1000, 't' : 1}
]
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		switch (isclear) {
			...
			case 4:
				var msg = "아르카나의.. 아름다움을 유지해다오.."+enter+enter;
				msg += "#fUI/UIWindow2.img/UtilDlgEx/list1#\r\n#d#L1#(Lv."+제한레벨+") #b#e[일일 퀘스트]#n#k #d아르카나 2";
		...
		if (getk("isclear") == 1 || getk("isclear") == 4) {
			var msg = "처리해줘야 할 임무는 아래와 같습니다!"+enter+enter;
			msg += isitem ? "#r#e[일일 퀘스트] : 아르카나#n#k"+enter : "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 아르카나#n#k"+enter;
		...
		var msg = "처리해줘야 할 임무는 아래와 같습니다!"+enter+enter;
		msg += isitem ? "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 아르카나#n#k"+enter : "#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n#r#e[일일 퀘스트] : 아르카나#n#k"+enter;
		msg += isitem ? "\r\n목표 전리품 : #b#i"+getk("mobid")+"##z"+getk("mobid")+"# "+getk("mobq")+"개#k"+enter+enter : "처치 대상 : #b#o"+getk("mobid")+"# "+getk("mobq")+"마리#k"+enter+enter;
		msg += "그럼, 일이 끝난 후에 다시 찾아와주십시오!";
		cm.sendOk(msg);
		cm.dispose();
