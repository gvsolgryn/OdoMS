...
function action(M, type, selection) {
	...
	talk+= "이번 주 자네에게 부탁할 일은 아래와 같다네.\r\n\r\n";
        ...
        if (St == 0) {
            dialogue = "#b#e<일일퀘스트 : 타락한 세계수>#k#n\r\n\r\n"
	    ...
	    var text2 = "자, 여기 #i4001868# #z4001868#를 3개 드렸습니다. 가져다 주신 아이템은 연구에 큰 도움이 될 거라네.\r\n\r\n";
	    text2 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n";
	    text2 += "#i4001868# #b#z4001868# #r#e3 개#k#n\r\n";
                cm.sendOk(text2);
