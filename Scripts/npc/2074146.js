...
function action(mode, type, selection) {
   ...
   if (status == 0) {
    말 = "#fs11##b차원의 스톤#k을 분해하러 온겐가?\r\n"
    말 += "분해하면 #r#z4310005##k을 #e랜덤#n으로 획득이 가능하다네.\r\n"
    말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
    ...
    cm.sendSimpleS(말, 0x04, 9401232);
        ...
        if (selection == 0) {
            if (!cm.haveItem(4310000, 1)) {
                cm.sendOkS("#fs11##i4310000# #b#z4310000##k 아이템이 부족하다네.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            cm.gainItem(4310000, -1);
            cm.gainItem(스톤, 일차원);
            cm.sendSimpleS("#fs11#축하하네, 분해한 결과라네!\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#b#i"+스톤+"##b#z"+스톤+"# "+일차원+"개#k\r\n\r\n#L0##b분해를 한번 더 진행 하겠습니다.", 0x04, 9401232);
        } else if (selection == 1) {
            if (!cm.haveItem(4310001, 1)) {
                cm.sendOkS("#fs11##i4310001# #b#z4310001##k 아이템이 부족하다네.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            ...
            if (!cm.haveItem(4310002, 1)) {
                cm.sendOkS("#fs11##i4310002# #b#z4310002##k 아이템이 부족하다네.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            ...
            if (!cm.haveItem(4310003, 1)) {
                cm.sendOkS("#fs11##i4310003# #b#z4310003##k 아이템이 부족하다네.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            ...
            if (!cm.haveItem(4310004, 1)) {
                cm.sendOkS("#fs11##i4310004# #b#z4310004##k 아이템이 부족하다네.", 0x04, 9401232);
                cm.dispose();
                return;
            }
