...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        말 = "#fs11##b#z" + itemid + "##k #r15개#k로 " + 검정 + "차원의 스톤 제작#k이 가능하네.\r\n";
    ...
    if (status == 1) {
        if (selection == 0) {
            ...
            if (leftslot < 2) {
                cm.sendOkS("#fs11##r기타창 2칸 이상을 확보해두게.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            if (!cm.haveItem(4310005, 15)) {
                cm.sendOkS("#r#i4310005##z4310005#이 부족하네.", 0x04, 9401232);
                cm.dispose();
                return;
            }
            if (Randomizer.isSuccess(60)) {
                lv1 = 4310000;
                cm.sendOkS("#fs11#차원의 스톤 제작에 성공했네!\r\n\r\n#k#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#i" + lv1 + "# #b#z" + lv1 + "# ", 0x04, 9401232);
                cm.gainItem(lv1, 1);
            } else if (Randomizer.isSuccess(20)) {
                lv2 = 4310001;
                cm.sendOkS("#fs11#차원의 스톤 제작에 성공했네!\r\n\r\n#k#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#i" + lv2 + "# #b#z" + lv2 + "# ", 0x04, 9401232);
                cm.gainItem(lv2, 1);
            } else if (Randomizer.isSuccess(5)) {
                lv3 = 4310002;
                cm.sendOkS("#fs11#차원의 스톤 제작에 성공했네!\r\n\r\n#k#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#i" + lv3 + "# #b#z" + lv3 + "# ", 0x04, 9401232);
                cm.gainItem(lv3, 1);
            } else if (Randomizer.isSuccess(2)) {
                lv4 = 4310003;
                cm.sendOkS("#fs11#차원의 스톤 제작에 성공했네!\r\n\r\n#k#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#i" + lv4 + "# #b#z" + lv4 + "# ", 0x04, 9401232);
                cm.gainItem(lv4, 1);
            } else if (Randomizer.isSuccess(1)) {
                lv5 = 4310004;
                cm.sendOkS("#fs11#차원의 스톤 제작에 성공했네!\r\n\r\n#k#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#i" + lv5 + "# #b#z" + lv5 + "# ", 0x04, 9401232);
                cm.gainItem(lv5, 1);
            } else {
                stone = 4310005;
                cm.sendOkS("#fs11##r차원의 스톤 제작에 실패했다네..#k\r\n\r\n#b#i" + stone + "# #z" + stone + "##k " + 개수 + "개가 지급되었습니다.", 0x04, 9401232);
