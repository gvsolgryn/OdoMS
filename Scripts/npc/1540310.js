...
function start() {
	...
	App = cm.getPlayer().FuckingRanking(4);
	...
	for (i = 1; i < App.size(); i++) {
		...
		순위 = (i == 1 ? " " + T2Num0 + T2Num1 + "#fs14##fc0xFFFF8224#" : i == 2 ? " " + T2Num0 + T2Num2 + "#fs14##fc0xFFFF8224#" : i == 3 ? " " + Num0 + Num3 : i == 4 ? " " + Num0 + Num4 : i == 5 ? " " + Num0 + Num5 : i == 6 ? " " + Num0 + Num6 : i == 7 ? " " + Num0 + Num7 : i == 8 ? " " + Num0 + Num8 : i == 9 ? " " + Num0 + Num9 : i == 10 ? " " + Num1 + Num0 : Num0)

		print.append(순위).append(" ─ #e#fs14#").append(App.get(i).getMid()).append("#k#n 님\r\n#fs11##fc0xFFFF007F#* 레벨#k : #r").append(Integer.parseInt(App.get(i).getRight())).append("#k #e/#n #d* 직업#k : #b").append(job).append("#k\r\n\r\n");
	}
