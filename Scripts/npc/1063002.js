...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		if (!(cm.getPlayer().getPosition().x < 1057 && cm.getPlayer().getPosition().x > 925 && cm.getPlayer().getPosition().y >= -3200 && cm.getPlayer().getPosition().y <= -2998)) {
