...
var logo = "                #fUI/Logo.img/Script/logo5#";
var enter = "\r\n";
var seld = -1;
...
var jobs = [
    ...
    { 'jobid': 3200, 'jobname': "베틀메이지", 'job': "레지스탕스", 'stat': 3, 'sk': [30001281, 30000012, 30000073] },
    ...
    { 'jobid': 16200, 'jobname': "라라", 'job': "아니마", 'stat': 3, 'sk': [160010000, 160011075] }
]
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        if (seld >= 1 && seld <= 5) {
            ...
            cm.warp(150, 0);
            cm.getPlayer().resetStats(4, 4, 4, 4);
            level = cm.getClient().getKeyValue("First200") == null ? level : 200;
