...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var chat = enter
        choose = "#fs11##r                 #h0##k님!#fc0xFF000000#  컨텐츠 시스템에 온 걸 환영해요!\r\n\r\n";
        choose += "#Cgray##fs11#―――――――――――――――― #fc0xFF228B22##e각종 컨텐츠#n#Cgray# ―――――――――――――――#fc0xFF000000#\r\n";
        choose += "#L5#" + 마라벨 + 연파랑 + " 캐시템 모루#l    ";
        choose += "#L6#" + 코인 + 연파랑 + " 데미지측정#l    ";
        choose += "#L9#" + 커플 + 연파랑 + " 어드벤쳐 드릴#l"
        choose += enter;
        choose += enter;
        choose += "#L14#" + 포켓 + 보라색 +" 무릉 도장#l       ";
        choose += "#L13#" + 펫 + 보라색 + " 길드시스템#l    ";
        choose += "#L11#" + 훈장 + 보라색 + " 유니온 기어#l";
        choose += enter;
        choose += enter;
        choose +="#L98#" + 집 + " 랭킹 확인#l       ";  
        choose +="#L99#" + 라이딩 + " 일일 퀘스트#l       ";
        choose +="#L10#" + 모루 + "#fc0xFFA566FF# 추천인#l"
        choose += enter;
        choose += enter;
        choose +="#L97#" + 룰렛 + " 경마장#l          "; 
        choose +="#L96#" + 룰렛 + " 가위바위보#l" 
        choose += enter;
        choose += enter;
        choose += "#Cgray##fs11#―――――――――――――――― #fc0xFF4682B4##e뽑기 시스템#n#Cgray# ―――――――――――――――#fc0xFF000000#\r\n";
        choose += "#L0#" + 뎀스 + 블루 + " 시드링#l            ";
        choose += "#L2#" + 의자 + 블루 + " 의자#l           ";
        choose += "#L3#" + 의자 + 블루 + " 데미지 스킨#l#k";
        ...
        if (selection == 0) {
            ...
            cm.dispose();
            cm.openNpc(9401232, "CashMoru"); //캐시 모루
        } else if (selection == 6) {
            cm.dispose();
            cm.openNpc(3004091); //데미지측정
        } else if (selection == 7) {
            cm.dispose();
            ...
            cm.dispose();
            cm.openNpc(3004430);
        } else if (selection == 96) { //치장강화
            cm.dispose();
            cm.openNpc(9062605);
        } else if (selection == 97) { //치장강화
            cm.dispose();
            cm.openNpc(9001014);
        } else if (selection == 98) { //치장강화
            cm.dispose();
            cm.openNpc(9076004);
        } else if (selection == 99) { //치장강화
            cm.dispose();
            cm.openNpc(2410006);
        } else if (selection == 16) { //핑예 선택
            var choose = "#fs11#" + 검정 + "닉스에서 핑크빈, 예티와 함께 모험을 떠나고 보상을 받아가세요!\r\n#r공사중입니다 보상은 추후 변경될 예정입니다@@\r\n";
