...
function action(mode, type, selection) {
    ...
    talk += "#L0#끝에 가까운 곳(#b노멀 모드#k)으로 이동한다.(레벨 255이상)#l\r\n"
    talk +="#L1#끝에 가까운 곳(#b하드 모드#k)으로 이동한다.(레벨 255이상)#l\r\n"
    talk += "#L2#끝에 가까운 곳(#b익스트림#k)으로 이동한다.(레벨 255이상)#l\r\n"
    talk += "#L3#끝에 가까운 곳(#b헬#k)으로 이동한다.(레벨 255이상)#l";
        ...
        if (cm.getParty() == null) {
            ...
            cm.dispose();
            return;
        } else if (cm.getPlayerCount(450012210) >= 1 || cm.getPlayerCount(450012600) >= 1 ) {
