...
닉스스킬 = "#fUI/Basic.img/theblackcoin/40#";
검정 = "#fc0xFF191919#"
노랑 = "#fc0xFFE0B94F#"
보라 = "#fc0xFFB677FF#"
보라색 = "#fc0xFF8041D9#"
...
function action(mode, type, selection) {
	...
	for (var i = 60000; i < 60015; i++) {
        ...
        choose += "#L16#" + 룰렛 + " #fc0xFF5954ED#룰렛 뽑기#l　";
        //choose += "#L17#" + 룰렛 + " #fc0xFFFFA648#클론 강화#l　\r\n\r\n";
        //choose += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        //choose += "#L5#" + 코인 + " " + 블루 + "파티퀘스트#k" + 검정 + "을 이용하고 싶습니다.\r\n#l";
        ...
        if (selection == 0) {
            ...
            var choose = "#fs11#" + 검정 + "닉스 페스티벌에 찾아온 핑크빈과 예티를 육성시키면 자네가 좋아할지도 모르는 다양한 아이템이 준비되어 있다네!\r\n";
            choose += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        ...
        if (sel == 4) { // 칭호 승급
            ...
            if (selection == 5) {
                ...
                말 += "#i4310291# #b#z4310291##k #r200개#k\r\n"
        ...
        if (selection == 100) {
            ...
            if (sell == 5) {
                if (cm.getPlayer().getMeso() < 700000000 || !cm.haveItem(4310010, 50) || !cm.haveItem(4310291, 200)) { //재료체크
                ...
                if (selection == 1) {
                    ...
                    말 += "#i4310291# #b#z4310291##k #r1,500개#k\r\n"
        ...
        if (sel == 5) {
            ...
            if (sel2 == 1) {
                if (!cm.haveItem(4310291, 1500)) {
                    cm.sendOkS("#b#i4310291##z4310291##k이 부족한거 같네.", 0x04, 9401232);
                    cm.dispose();
                    return;
                }
            }
            ...
            if (sel2 == 1) {
                cm.gainItem(4310291, -needstardust);
