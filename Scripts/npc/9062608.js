...
function action(mode, type, selection)
{
	...
	if (status == 0) {
		...
		arcaneImg = "#fUI/UIWindow.img/ToolTip/WorldMap/ArcaneForce#";
		starForceImg = "#fUI/UIWindow.img/ToolTip/WorldMap/StarForce#";		
		selStr += "#fs11##fc0xFF000000#[#e#rEASY#k#l]#k\r\n";
                        selStr += "#L1##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 50  | 자쿰#l\r\n";
                        //selStr += "#L2##fc0xFF6799FF#Lv.0#d | "+starForceImg+" 50  | 카웅#l\r\n";
                        selStr += "#L3##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 50  | 혼테일#l\r\n";;
                        selStr += "#L4##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 50  | 힐라#l\r\n";
                        selStr += "#L5##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 50  | 반레온#l\r\n";
                        selStr += "#L6##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 50  | 아카이럼#l\r\n";
                        selStr += "#L7##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 60  | 핑크빈#l\r\n";
                        selStr += "#L8##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 60  | 시그너스#l\r\n\r\n";
		selStr += "#fs11##fc0xFF000000#[#e#rNOMARL#k#l]#k\r\n";
                        selStr += "#L9##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 80  | 매그너스#l\r\n";
                        selStr += "#L10##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 80  | 루타비스#l\r\n";
                        selStr += "#L11##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 80  | 파풀라투스#l\r\n\r\n";
		selStr += "#fs11##fc0xFF000000#[#e#rHARD#k#l]#k\r\n";
                        selStr += "#L12##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 100  | 스우#l\r\n";
                        selStr += "#L13##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 100  | 데미안#l\r\n";
                        selStr += "#L14##fc0xFF6799FF#Lv.220#d | "+arcaneImg+" 360  | 루시드#l\r\n";
                        selStr += "#L15##fc0xFF6799FF#Lv.235#d | "+arcaneImg+" 760  | 윌    #l\r\n";
                        //selStr += "#L16##fc0xFF6799FF#Lv.0#d | "+arcaneImg+" 0  | 불꽃늑대#l\r\n";
                        //selStr += "#L17##fc0xFF6799FF#Lv.0#d | "+arcaneImg+" 0  | 우르스#l";
                        selStr += "#L20##fc0xFF6799FF#Lv.245#d | "+arcaneImg+" 730  | 더스크#l\r\n";
                        selStr += "#L19##fc0xFF6799FF#Lv.255#d | "+arcaneImg+" 850  | 듄켈   #l\r\n";						
                        selStr += "#L18##fc0xFF6799FF#Lv.250#d | "+arcaneImg+" 900  | 진힐라#l\r\n";
                        selStr += "#L21##fc0xFF6799FF#Lv.255#d | "+arcaneImg+" 1320  | 검은마법사   #l\r\n";
                        selStr += "#L22##fc0xFF6799FF#Lv.265#d | "+starImg+" 200  | 세렌#l";
