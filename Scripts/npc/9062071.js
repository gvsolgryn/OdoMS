...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg += "\r\n(1) 일일퀘스트#k\r\n";
		//var msg = "#L1##b 유니온 등급 관리#n #k\r\n";
		//msg += "#L20##b 유니온 기어등급 관리#n #k\r\n\r\n";
		msg += "#L30##b 새벽의이슬 퀘스트 교환#n #k\r\n\r\n";
		msg += "#L11# #b 요일별 퀘스트 #n #k\r\n";
		//msg += "#L12# #b 지원을 받고 싶어요.#n #k\r\n";
		//msg += "#l\r\n(2) 무릉도장 #k\r\n";
		//msg += "#L24# #b무릉도장 이동#n#l\r\n"
		//msg += "#L4# #b각종 랭킹확인#n #k\r\n\r\n";
		//msg += "#L10# #b버프를 구매하고 싶어요.#n #k\r\n";
		//msg += "#L20##b 유니온 기어#n #k\r\n";
		//msg += "#l\r\n(3) 기타#k\r\n";
		//msg += "#L5# #b길드 생성#n #k\r\n";
		//msg += "#L50# #b스킬 학습#n #k\r\n";
