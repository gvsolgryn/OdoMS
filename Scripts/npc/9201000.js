...
var price1 = 25000; //후포가격
var price2 = 50000; //홍포가격
...
function action(mode, type, selection) {
	...
	cm.sendSimpleS(chat, 0x04, 9401232);
    	} else if (status == 1) {
	sel = selection;
		var msg = "#fs11#무엇을 지불해서 만드실건가요?#fs11##b\r\n";
		msg += "#L100##fs11# 후원 포인트 (올스텟 300/ 공마 300, "+price1+"포인트 지불)\r\n";
		msg += "#L101##fs11# 홍보 포인트 (올스텟 300/ 공마 300, "+price2+"포인트 지불)\r\n";
		cm.sendSimpleS(msg, 0x04, 9401232);
    } else if (status == 2) {
	seld = selection;
