...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        말 = "#fs11#" + 검정 + "#h0#님! 부족한 점이 있으신가요?, 그렇다면! #rHEINZ 서버#k" + 검정 + "에선 신비한 스킬로 해결해 드려요!! \r\n";
        말 += "#fc0xFFD5D5D5#────────────────────────────#k#fs11\r\n";
        말 += "#L5##s1005# #b영웅의 메아리#k를 구매하고 싶습니다.#k#l\r\n";
        ...
        if (selection == 5) {
            ...
            level = 10;
            skillname = "HEINZ 가호";
            skilltesc = "특별한 힘을 지니고 있는 " + 남색 + "HEINZ 가호#k다.";
        } else if (selection == 2) {
            skillid = 80000578;
            level = 5;
            skillname = "무극";
        ...
        if (selection == 100) {
            ...
            스킬이름 = skillid == 1005 ? "영웅의 메아리" : skillid == 80000577 ? "HEINZ 가호" : skillid == 80000578 ? "무극" : skillid == 80000588 ? "탐욕스러운자" : skillid == 80001829 ? "비연" :"";
            ...
            sel = selection == 1005 ? "영웅의 메아리" : selection == 80000577 ? "HEINZ 가호" : selection == 80000578 ? "무극" : selection == 80000588 ? "탐욕스러운자" : selection == 80001829 ? "비연" : "";
        ...
        if (구매 == 1) {
            ...
            if (강화 == 0) {
                스킬이름 = skillid == 1005 ? "아케인 포스" : skillid == 80000577 ? "HEINZ 가호" : skillid == 80000578 ? "무극" : skillid == 80000588 ? "탐욕스러운자" : skillid == 80001829 ? "비연" : "";
