...
var item = [
	...
	[5068301, "닉스베리", 1, 10000],
	[5062006, "플래티넘 언리미티드 ", 1, 1500],
	[5069100, "루나 크리스탈", 1, 2000],
	[5060048, "골드애플", 1, 2000],
	[2049361, "놀라운 장비강화 주문서", 1, 3000],
	[2049136, "놀라운 닉스 혼돈 줌서", 1, 3000],
	[2046025, "닉스 한손 무기 공", 1, 3500],
	[2046026, "닉스 한손 무기 마", 1, 3500],
	[2046119, "닉스 두손 무기 공", 1, 3500],
	[2430030, "보스 입장 초기화+", 1, 4000],
	[2049704, "레전드리 잠재 부여 주문서", 1, 5000],
	[2430034, "안드로이드 각인서", 1, 8000],
	[4033449, "하양 마정석", 1, 7500],
	...
	[1003990, "SPACE 머리 구매x수정중", 1, 15000],
	[1042300, "SPACE 상의 구매x수정중", 1, 15000],
	[1062194, "SPACE 하의 구매x수정중", 1, 15000],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        chat = "#fs11#";
        chat = "#fs11#현재 #h0#님의 후원포인트 : #r" + cm.getPlayer().getDonationPoint() + "#k\r\n";
