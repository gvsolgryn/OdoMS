...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "#fUI/UIWindow5.img/Disguise/backgrnd2#";
        cm.sendYesNo(text);
    } else if (status == 1) {
        FirstJob(cm.getJob());
    } else if (status == 2) {
        ...
        if (selection >= 1 && selection <= 5) {
            ...
            switch (cm.getJob()) {
                ...
                case 15000: //일리움
                    ...
                    cm.addEquip(-10, 1353500, 0, 0, 0, 0, 0, 0);
                    break;
...
function FirstJob(i) {
    var chat = "#fs 11##fc0xFF990033#[닉스]#fc0xFF000000#에 온걸 환영하네. 모험을 떠날 준비는 되었는가?\r\n준비가 되었다면 원하는 직업을 선택하게.\r\n\r\n";
    switch (i) {
        case 0:
