...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("#fs11#안녕하세요? 성형 헤어 검색에 오신걸 환영합니다!\r\n\r\n#b#L1#검색 헤어#l#L2#검색 성형#l");
    } else if (status == 1) {
        choice = selection;
        var text;
        if (choice == 1) {
        ...
        cm.sendGetText("#fs11#검색#n#k 하고자 하는 #b" + text + "#n#k 이름#n#k 혹은 그 이름#n#k의 일부#n#k를 입력#n#k해 주세요.\r\n\r\n");
    } else if (status == 2) {
        ...
        if (choice == 1) {
            if (cm.getText().contains("헤어") || cm.getText().contains("머리")) {
                cm.sendOk("#fs11##r#e헤어, 머리#n#k가 들어간 검색어는 검색#n#k할 수 없습니다.\r\n\r\n" +
            ...
            if (cm.getText().contains("성형") || cm.getText().contains("얼굴")) {
                cm.sendOk("#fs11##r#e성형, 얼굴#n#k이 들어간 검색어는 검색#n#k할 수 없습니다.\r\n\r\n" +
