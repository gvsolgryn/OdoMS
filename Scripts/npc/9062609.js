...
var skills = [
	//["ww_magu", 2001002, "매직 가드", 50000, true],
	["ww_sharp", 3121002, "샤프아이즈", 150000, true], 
    ["ww_winb", 5121009, "윈드 부스터", 100000, true],
	["ww_holy", 2311003, "홀리심불", 200000, true],
            ["ww_buck", 5321054, "벅 샷", 400000, true],
            ["ww_crsca", 1311015, " 크오체", 400000, true],
            ["ww_quiver", 4341002, "파이널 컷", 500000, true],
]
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		//msg += "#L7# #d후원 포인트 상점#k (아이템)"+enter;
                msg += "#L2# #d후원 스킬 상점#k "+enter;
                msg += "#L3# #d윔 배우기#k "+enter;
//msg += "#L9# #d후원 스킬 상점#k "+enter;
		...
		switch (sel) {
			...
			return;
				...
				msg += "현재 #h #님의 후원포인트 : #r"+cm.getPlayer().getDonationPoint()+"P#k#fs11#"+enter+enter;
				msg += "현재 #h #님의 보유한 추가타 보너스 : #r"+cm.getPlayer().getKeyValue(99999, "triplingBonus")+" 타#k#fs11#"+enter+enter;
