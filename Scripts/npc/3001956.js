...
var cao = [
    {'itemid': 1113282, 'qty': 1, 'allstat': 30, 'atk': 30,
        'recipes': [[1113089, 1], [1113089, 1], [1032227, 1]], 'price': 1000000000, 'chance': 100,
        'fail': [[4319999, 1]]
    },
    {'itemid': 1122150, 'qty': 1, 'allstat': 30, 'atk': 30,
        'recipes': [[1022232, 1], [1122254, 1], [1032136, 1], [4319999, 1000]], 'price': 1000000000, 'chance': 100,
        'fail': [[4319999, 1]]
    },
    {'itemid': 1113070, 'qty': 1, 'allstat': 30, 'atk': 30,
        'recipes': [[2434587, 30], [2434586, 30], [2434585, 30], [2434584, 30], [4310064, 50]], 'price': 1000000000, 'chance': 100,
        'fail': [[4319999, 1]]
    },
    {'itemid': 1672077, 'qty': 1, 'allstat': 30, 'atk': 30,
        'recipes': [[1012478, 1], [1022231, 1], [1113149, 1], [1032241, 1]], 'price': 1000000000, 'chance': 100,
        'fail': [[4319999, 1]]
    },
    {'itemid': 1113055, 'qty': 1, 'allstat': 30, 'atk': 30,
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        if (!canMake) {
            cm.sendOk("#fs11#" + "재료가 충분한지 다시 한 번 확인해주세요.");
            cm.dispose();
            return;
        }
        payItems(item);
