...
function start() {
	...
	var pv = cm.itemQuantity(1142068); // 상급기사
	    if (vh >= 3000 && zs >= 3000 && hs >= 3000 && pb >= 3000 && pv >= 1){
	...
	if (cm.getPlayer().getLevel() <= 999 && cm.getPlayer().getMapId() == 100030301) {
	    ...
	    chat += "#r[보상]#k #i4001716# #b10억 주화#k #r10 개#k\r\n#r[보상]#k #i1142069# #b#z1142069##k #r올스탯 200 / 공, 마 100#k\r\n";
            } else {
	    chat += "#r[보상]#k #i4001716# #b10억 주머니#k #r3 개#k";
            }
	    chat += "\r\n--------------------------------------------------------------------------------\r\n";
            chat += "                          #d[요청 아이템 목록]#k\r\n";
            chat += "--------------------------------------------------------------------------------\r\n";
	    chat += "#i4000994# #z4000994#            #d("+vh+"/3000)#k\r\n";
	    chat += "#i4000995# #z4000995#                 #d("+zs+"/3000)#k\r\n";
	    chat += "#i4000996# #z4000996#                     #d("+hs+"/3000)#k\r\n";
	    chat += "#i4000997# #z4000997#                        #d("+pb+"/3000)#k\r\n";
		chat += "#i1142068# #z1142068#                        #d("+pv+"/1)#k\r\n";
	    chat += "--------------------------------------------------------------------------------\r\n";
	    chat += ""+sel+"";
	    chat += "--------------------------------------------------------------------------------\r\n";
            chat += ""+sel2+"";
...
function action(mode, type, selection) {
	...
	if (selection == 0) {
        ...
        if (cm.getQuestStatus(400) == 0) {
	    if (cm.haveItem(4000994, 3000) && cm.haveItem(4000995, 3000) && cm.haveItem(4000996, 3000) && cm.haveItem(4000997, 3000)) {
		 if (cm.canHold(4001716) && cm.canHold(1142069)) {
			 cm.sendOk("#fn나눔고딕 Extrabold#덕분에 #r유기농 채소#k 를 재배하기가 훨씬 수월해졌군..\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n#i4001716# #b10억 주화#k #r10 개#k\r\n#i1142069# #b깜찍한 뉴비#k #r(올스탯 150 / 공, 마 150)#k");
			 cm.gainItem(4000994, -3000);
			 cm.gainItem(4000995, -3000);
			 cm.gainItem(4000996, -3000);
			 cm.gainItem(4000997, -3000);
			 cm.gainItem(1142068, -1);
			 cm.gainItem(4001716, 10);
	item = Packages.server.MapleItemInformationProvider.getInstance().getEquipById(1142069);
	item.setStr(200);
	item.setDex(200);
	item.setInt(200);
	item.setLuk(200);
