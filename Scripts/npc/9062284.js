...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		var chat = enter
		choose += "" + " 　　　　　　　　      #fUI/Basic.img/theblackcoin/35#닉스 성장 시스템#fUI/Basic.img/theblackcoin/35##l　\r\n";
		choose += "#L0#" + "　　　　　  　　" + 포켓 + " #fc0xFFF15F5F#닉스 성장 다이어리 " + 포켓 + "                       #l　\r\n\r\n";
        choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  강화 시스템  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
		choose += "#L1#" + 의자 + " #fc0xFFF15F5F#방어구 강화     #l#k";
        choose += "#L2#" + 뎀스 + " #fc0xFF6799FF#장신구 강화     #l#k";
        choose += "#L3#" + 라이딩 + " #fc0xFFA566FF#치장템 강화#l　\r\n\r\n";
		choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  승급 시스템  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
        choose += "#L4#" + 블랙스킬 + " #fc0xFF5954ED#강화석 승급     #l#k";
        choose += "#L5#" + 마라벨 + " #fc0xFF5954ED#칭호 승급#l　\r\n\r\n";
		choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  제작 시스템  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
		choose += "#L6#" + 무릉 + " #fc0xFFFF5E00#아이템 제작#l　\r\n";
        ...
        if (selection == 0) {
            ...
            cm.dispose();
            cm.openNpc(3004442); //방어구 강화
        } else if (selection == 2) {
            cm.dispose();
            cm.openNpc(3004441); //장신구 강화
        } else if (selection == 3) {
            cm.dispose();
            cm.openNpc(3005381); //치장템 강화
        } else if (selection == 4) {
            cm.dispose();
            cm.openNpc(2540011); //강화석 승급
        } else if (selection == 5) {
            cm.dispose();
