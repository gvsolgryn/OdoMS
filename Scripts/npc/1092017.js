var itmelist = [
    [2048767, 1000, 5], // 검환불
    [2470021, 50000, 1], // 업횟5 황망
    [5062006, 1000, 1], //플래티넘  큐브
    [5062005, 2000, 1], //어메이징미라클
    [5062503, 2000, 1], //화이트 에디셔널 큐브	
    [5060048, 1500, 1], //애플
    [2049360, 3000, 1], // 놀장강
    [2435899, 5000, 1], //위대한 소울 선택상자
    [2049704, 1000, 1], //레전드리 잠재 부여 주문서
    [2430215, 8000, 1], // 안드로이드 각인서
    [2430068, 30000, 1], //루나쁘띠 1~4기 펫
    [2430368, 10000, 1], //스네이크 헌터 악세서리
    [2430031, 10000, 1], //아케인심볼 : 여로 20렙
    [2430032, 10000, 1], // 아케인심볼 : 츄츄 20렙
    [2430033, 10000, 1], // 아케인심볼 : 레헬른 20렙
    [2430049, 10000, 1], // 아케인심볼 : 아르카나 20렙
    [2430051, 10000, 1], // 아케인심볼 : 모라스 20렙
    [2430052, 10000, 1], // 아케인심볼 : 에스페라 20렙
    [2633616, 30000, 1], // 어센틱심볼 : 세르니움 11렙
    [2633336, 30000, 1], // 어센틱심볼 : 아르크스 11렙
    [2439999, 60000, 1], // 어센틱심볼 : 오디움 11렙
    [2049376, 10000, 1], // 스타포스 20성 강화권
    [2643133, 5000, 1], // 어웨이크링 주문서
    [1114318, 30000, 1], // 어웨이크링	
    [4310021, 3000, 1], // 스타포스 10% 확률 업 티켓
    [2430030, 15000, 1], // 보스초기화권	
    [2047950, 4000, 1], // 방어구주문서
    [2046831, 5000, 1], // 악세공
    [2046832, 5000, 1], // 악세마
    [2048096, 5000, 1], // 펫공
    [2048097, 5000, 1], // 펫마
