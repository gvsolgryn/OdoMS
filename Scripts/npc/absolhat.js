...
var items = [
   {'itemid' : 1004032, 'qty' : 1, 'allstat' : 0, 'atk' : 80,
   'recipes' : [[4310065, 300], [4021031, 1000], [4310237, 3000], [4009005, 300]], 'price' : 1500000000, 'chance' : 30,
   'fail' : [[4001715, 1]]
   },
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      ...
      msg += enter;
      msg += "#fs11##k선택하신 아이템을 제작하기 위한 레시피입니다.#fs11##d"+enter;
      msg += "#fs11##r해당 아이템은 이노센트 류 주문서를 바르면 안됩니다.#k"+enter+enter;
