...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		if (!(cm.getPlayer().getPosition().x < -1507 && cm.getPlayer().getPosition().x > -1750 && cm.getPlayer().getPosition().y >= -1693 && cm.getPlayer().getPosition().y <= -1586)) {
