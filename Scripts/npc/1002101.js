...
var bosslist = [ 
    ["Normal", "[Normal] 자쿰", "Normal_Zakum", 2430030, 1, 1, 2430030], //ok
    ["Normal", "[Chaos] 자쿰", "Chaos_Zakum", 2430030, 1, 1, 2430030],
    ["Normal", "[Normal] 혼테일", "Normal_Horntail", 2430030, 1, 2, 2430030], //no
    ["Normal", "[Chaos] 혼테일", "Chaos_Horntail", 2430030, 1, 2, 2430030, 7312, 2430030],
    ["Normal", "[Normal] 카웅", "Normal_Kawoong", 2430030, 1, 21, 2430030], //ok
    ["Normal", "[Normal] 힐라", "Normal_Hillah", 2430030, 1, 3, 2430030], //ok
    ["Normal", "[Hard] 힐라", "Hard_Hillah", 2430030, 1, 3, 2430030],
    ["Normal", "[노멀하드] 반 레온", "Normal_VonLeon", 2430030, 1, 8, 2430030], //OK
    ["Normal", "[Hard] 반 레온", "Hard_VonLeon", 2430030, 1, 8, 2430030],
    ...
    ["Normal", "[카오스] 핑크빈", "Chaos_Pinkbean", 2430030, 1, 11, 2430030], //OK
    ["Normal", "[Normal] 시그너스", "Normal_Cygnus", 2430030, 1, 12, 2430030], //
    ["Normal", "[Normal] 매그너스", "Normal_Magnus", 2430030, 1, 10, 2430030],
    ["Normal", "[Hard] 매그너스", "Hard_Magnus", 2430030, 1, 10, 0],
    ["Normal", "[이지노멀] 파풀라투스", "Normal_Populatus", 2430030, 1, 22, 2430030], //ok
    ["Normal", "[Chaos] 파풀라투스", "Chaos_Populatus", 2430030, 1, 22, 2430030],
    ["Normal", "[Normal] 피에르", "Normal_Pierre", 2430030, 1, 4, 2430030],
    ["Normal", "[Chaos] 피에르", "Chaos_Pierre", 2430030, 1, 4, 2430030],
    ["Normal", "[Normal] 반반", "Normal_VonBon", 2430030, 1, 5, 2430030],
    ["Normal", "[Chaos] 반반", "Chaos_VonBon", 2430030, 1, 5, 2430030],
    ["Normal", "[Normal] 블러디퀸", "Normal_BloodyQueen", 2430030, 1, 6, 2430030],
    ["Normal", "[Chaos] 블리디퀸", "Chaos_BloodyQueen", 2430030, 1, 6, 2430030],
    ["Normal", "[Normal] 벨룸", "Normal_Vellum", 2430030, 1, 7, 2430030],
    ["Normal", "[Chaos] 벨룸", "Chaos_Vellum", 2430030, 1, 7, 2430030],
    ["Normal", "[Normal] 스우", "Normal_Lotus", 2430030, 1, 13, 2430030],
    ["Normal", "[Hard] 스우", "Hard_Lotus", 2430030, 1, 13, 2430030],
    ["Normal", "[Normal] 데미안", "Normal_Demian", 2430030, 1, 15, 2430030],
    ["Normal", "[Hard] 데미안", "Hard_Demian", 2430030, 1, 15, 2430030],
    ["Normal", "[Normal] 루시드", "Normal_Lucid", 2430030, 1, 19, 2430030],
    ["Normal", "[Hard] 루시드", "Hard_Lucid", 2430030, 1, 19, 2430030],
    ["Normal", "[Normal] 윌", "Normal_Will", 2430030, 1, 23, 2430030],
    ["Normal", "[Hard] 윌", "Hard_Will", 2430030, 1, 23, 2430030],
    ["Normal", "[Normal] 듄켈", "Normal_Dunkel", 2430030, 1, 27, 2430030],
    ["Normal", "[Normal] 더스크", "Normal_Dusk", 2430030, 1, 26, 2430030],
    ["Normal", "[Chaos] 더스크", "Chaos_Dusk", 2430030, 1, 26, 2430030],
    ["Hard", "[Hard] 진 힐라", "Normal_JinHillah", 2430030, 1, 24, 2430030],
    ["Hard", "[Hard] 검은마법사", "Black_Mage", 2430030, 1, 25, 2430030],
    ["Hard", "[Hard] 세렌", "Hard_Seren", 2430030, 1, 28, 2430030]
];
