...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        var msg = "#fs11# 안녕하세요. #eHEINZ#n 홍보포인트 지급 도우미 입니다.\r\n " + enter;
        msg += "현재 #b#h ##k님의 홍보 포인트 : #b" + cm.getPlayer().getHPoint() + "P#k" + enter;
        //msg += "현재 #b#h ##k님의 홍보 등급 : #b" + cm.getPlayer().getPgrades() + "#k#b" + enter;
        msg += "현재 #b#h ##k님의 누적 횟수 : #b" + cm.getPlayer().getClient().getKeyValue("PNumber") + "회#k#b" + enter + enter;
        msg += "#L1#홍보포인트 수령하기" + enter;
        //msg += "#L2#홍보포인트 랭킹확인"+enter;
        msg += "#L5#홍보포인트 상점" + enter;
        //msg += "#L7#누적 횟수 보상 수령하기"+enter;
        if (cm.getPlayer().isGM()) {
            msg += "#L3#홍보포인트 지급하기" + enter;
        ...
        switch (sel) {
            ...
            case 7:
                ...
                var msg = "#b누적 홍보 " + NumReward[g]['n'] + "회#k를 달성하신 것을 축하합니다!" + enter;
                msg += "낮은 등급의 보상부터 차례차례 받게 됩니다." + enter;
                msg += "현재 받을 보상은 #b홍보 " + NumReward[g]['n'] + "회차, 단풍리 " + grade[g + 3][1] + " 등급#k의 보상입니다." + enter + enter;
        ...
        switch (seld) {
            ...
            case 6:
                ...
                var msg = "#b" + name + "#k의 홍보등급을 몇 회로 설정 하시겠습니까?" + enter;
                if (modifychr == null) {
        ...
        switch (seld) {
            ...
            case 5:
                ...
                msg += "현재 #h 0#님의 남은 홍보포인트 : #e#b" + cm.getPlayer().getHPoint() + "P#k#n";
                cm.sendOk(msg);
                cm.dispose();
                break;
            case 6:
