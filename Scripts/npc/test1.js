            ...
            if (St == 4 && rotation == 2) {
                ...
                switch (S3) {
                    ...
                    case 16:
                        ...
                        break;
                    case 17:
                        inz.setAmazingequipscroll(!inz.isAmazingequipscroll());
                        break;
                    case 18:
...
function addItemInfo() {
    if (rotation == 0) {
        ...
        txt = "#r#e[아이템 기본 옵션]#n\r\n#b#fs11#";
        sel = ["힘", "덱스", "인트", "럭", "최대 체력(HP)", "최대 마나(MP)", "공격력", "마력", "물리방어력", "마법방어력", "명중률", "회피치", "스피드", "점프력", "주문서 성공 횟수", "업그레이드 가능 횟수", "스타포스 성공 횟수", "놀라운 장비강화 주문서 사용 여부", "보스 공격 시 데미지", "몬스터 방어력 무시", "총 데미지", "올스탯", "착용 레벨 감소", "잠재능력 등급", "1 번째 잠재능력", "2 번째 잠재능력", "3 번째 잠재능력", "4 번째 잠재능력", "5 번째 잠재능력", "6 번째 잠재능력"];
