...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        txt = "#b#e<싸워라! 전설의 귀환>#n#k\r\n\r\n가상 전투 프로그램 시스템 작동 완료.\r\n\r\n#b"
        txt += "#L0#<싸워라! 전설의 귀환>에 대해 설명을 듣고 싶어요.\r\n"
        txt += "#L1#이곳에서 나가고 싶어요."
        cm.sendSimple(txt);
    } else if (status == 1) {
        if (selection == 0) {
            ...
            말 += "싸워라 전설의 귀환 은 매시 #b21시 15분/45분#k 마다 머리 위로 초대장이 날아오며 #b길드#k에 가입되어 있다면 누구나 참여 하실 수 있습니다.\r\n#r(초보자 길드 'Black' 제외)#k\r\n\r\n"
