...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		var msg = "#fs11#어서오세요 #h0#님! 어디로 이동하시겠어요?\r\n";
		msg += "#L1# #b마을을 이동하고 싶습니다.#n #k\r\n";
		//msg += "#L6# #b기념 이벤트 장소로 이동하고 싶습니다.#n #k\r\n";
		//msg += "#L7# #b시즌 이벤트 장소로 이동하고 싶습니다.#n #k\r\n";
		msg += "#L2# #b사냥터로 떠나고 싶습니다.#n #k\r\n";
		msg += "#L3# #b자동 사냥터로 이동하고 싶습니다.#n #k\r\n";
		msg += "#L4# #b티어 사냥터로 이동하고 싶습니다.#n #k\r\n";
 		msg += "#L10# #b잠수 포인트를 쌓으러 이동하고 싶습니다.#n #k\r\n";
		msg += "#L8# #b추억을 남기기 위해 특별한곳으로 가고 싶습니다.#n #k\r\n";
		if(GameConstants.isWildHunter(cm.getPlayer().getJob()))
		msg += "#L9# #b재규어를 잡으러 가고 싶습니다.#n #k\r\n";
		//msg += "#L999# #b테스트#n #k\r\n";
		...
		switch (ans_01) {
			...
			case 6:
				selStr += "\r\n";
				selStr += "#L1##fs11# #e#d어드벤처 아일랜드#n #k이동\r\n";
				selStr += "#L2# #e#d메이플 연합 전초기지#n #k이동\r\n";
