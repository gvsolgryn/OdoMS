...
function action(mode, type, selection) {
    ...
    for (i = 1; i <= 10; i++) {
        if (i != 1)
            talk += "\r\n";
        talk += "#e- " + i + " ~ " + (i * 4) + "마리 : #i4310308##z4310308# " + (i * 10) + "개#n"
    }
    dialogue = [
        ["nextprev", 0, "#fs11##b#e<어드벤처 드릴>#k#n은 1분 안에 최대한 많은 #e허수아비 몬스터#n를 처치하는 미션이다."],
        ["nextprev", 0, "#fs11#총 10개의 발판마다 각각 종류가 다른 허수아비 몬스터 4종이 배치되어 있지."],
        ["nextprev", 0, "#fs11##b#e<일반 허수아비>#k#n\r\n\r\n#fMob/9300799.img/stand/0#\r\n첫 번째로 #e일반 허수아비.#n 별 다른 특징은 없다."],
        ["nextprev", 0, "#fs11##b#e<웡키 허수아비>#k#n\r\n\r\n#fMob/9305681.img/stand/0#\r\n두 번째는 #e웡키 허수아비#n다.\r\n일반 허수아비와 다르게 #e방어율#n을 갖추고 있지."],
        ["nextprev", 0, "#fs11##b#e<껨디 허수아비>#k#n\r\n\r\n#fMob/9305678.img/stand/0#\r\n세 번째로 #e껨디 허수아비#n다.\r\n일반 허수아비와 다르게 #e높은 체력과 보스 몬스터 속성#n을 지녔다고 알려져 있다."],
        ["nextprev", 0, "#fs11##b#e<소공 허수아비>#k#n\r\n\r\n#fMob/9305679.img/stand/0#\r\n마지막으로 #e소공 허수아비.#n\r\n위쪽 발판으로 갈수록 점점 #e레벨#n이 올라가지."],
        ["nextprev", 0, "#fs11#당연히 각각의 허수아비들은 올라갈수록 더 강한 체력과 능력을 갖추고 있다."],
        ["nextprev", 0, "#fs11#1분 동안 얼마나 많은 허수아비를 처치했느냐에 따라서          #b#e#i4310308##z4310308##k#n을 지급해 주도록 하지."],
        ["nextprev", 0, talk],
        ["nextprev", 0, "#fs11##b#e<어드벤처 드릴>#k#n은 #r#e캐릭터 당 하루 한 번#k#n만 받아갈 수 있다는 점 명심하도록."],
        ["nextprev", 0, "#fs11#참고로 처치 결과가 마음에 들지 않는다면 #e보상 획득을 포기#n하고 언제든 #e재도전#n이 가능하다."],
        ["nextprev", 0, "#fs11#오직 강인한 전사만이 새로운 모험을 즐길 자격이 있는 법!"],
        ["nextprev", 0, "#fs11#가라! #b" + cm.getPlayer().getName() + "#k!\r\n#b#e<어드벤처 드릴>#k#n을 정복하고 돌아와라!"]
    ]
    if (mode == -1) {
        cm.dispose();
        return;
    ...
    if (status == 0) {
        talk = "#fs11##e<어드벤처 드릴>#n을 시작할 준비가 됐나?\r\n\r\n"
		...
		if (cm.getClient().getKeyValue("AdventureDrill"+date) != null) {
			cm.sendOk("오늘은 이미 다녀왔습니다.");
			cm.dispose();
			return;
		} else {
