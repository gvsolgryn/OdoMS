...
howsec = 5; // 얼마를 주기로 몹을 리스폰 할지 [단위 : 초]
	...
	if (getk("day") == 6) {
        ...
        if (selection == 0) {
            ...
            for (i = 0; i < mobid.length; i++) {
                gL = Math.floor(cm.getPlayer().getLevel() / 5) - 20
