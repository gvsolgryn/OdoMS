 ...
 */
 ...
 var KEEP_LEVEL_PERCENT = 10000; //옵이탈 낮을수록
 var enter = "\r\n";
 ...
 function action(mode, type, selection) {
     ...
     if (status == 0) {
         ...
         chat += enter + enter;
         chat += "#L" + CubeStatus.BLACK_CUBE + "# 플래티넘 미라클 큐브" + enter;
         //chat += "#L" + CubeStatus.ADDITIONAL_CUBE + "# 마스터 미라클 큐브" + enter;
 ...
 function createPotentialMap() {
     ...
     _potentialMap.put(40056, new PotentialStruct(_potential, 1));
     _potentialMap.put(40057, new PotentialStruct(_potential, 1));
