...
var items = [
   {
      'itemid': 1009984, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1003797, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1003797, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042985, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042254, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042254, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062985, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062165, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062165, 1]] //성공시 지급되는 아이템
   },


   {
      'itemid': 1009985, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1003798, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1003798, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042986, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042255, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042255, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062986, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062166, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062166, 1]] //성공시 지급되는 아이템
   },


   {
      'itemid': 1009987, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1003800, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1003800, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042988, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042257, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042257, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062988, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062168, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062168, 1]] //성공시 지급되는 아이템
   },


   {
      'itemid': 1009986, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1003799, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1003799, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042987, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042256, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042256, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062987, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062167, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062167, 1]] //성공시 지급되는 아이템
   },


   {
      'itemid': 1009988, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1003801, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[2000005, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042989, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042258, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042258, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062989, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062169, 1], [4319999, 10000]], 'price': 15000000000, 'chance': 100, //재료, 비용, 확률
...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      ...
      msg += "#L3#저는 #e궁수#n 아이템을 만들고 싶습니다.\r\n"
      msg += "#L2#저는 #e도적#n 아이템을 만들고 싶습니다.\r\n"
