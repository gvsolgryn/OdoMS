...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var text = ""
            text = "#fs11#" + 검정 + "저는 #fc0xFF000087#[닉스]#k " + 검정 + "컨텐츠 부서에서 #b라이딩 뽑기#k" + 검정 + "를 담당하고 있는 포밍이라고 합니다."
            text += "\r\n라이딩 뽑기 한번 당 #r#z4310291# 65개#k" + 검정 + "로 가 가능합니다.\r\n\r\n";
