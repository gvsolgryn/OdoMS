...
ccoin = 4310248; // 코인코드
    ...
    if (status == 0) {
        말 = "#fs11##fn나눔고딕 Extrabold##d 제일 빨리 달리는 달팽이는 누굴까요?!\r\n제일 빠른 몬스터를 맞추시면 #i4310248 닉스 코인 을##r5배#k#d로 드려요!\r\n\r\n#r분홍콩의 개수를 적어주세요.)#n#k"
		...
		if (st2 == win) {
			cm.sendOk("#fn나눔고딕 Extrabold##fs11##d 승리하셨습니다. 코인을 5배로 드릴게요!");
			cm.gainItem(ccoin, st*5);
		} else {
			cm.sendOk("#fs11##fn나눔고딕 Extrabold##d 코인... 냠냠.....");
		}
		cm.dispose();
    }
}