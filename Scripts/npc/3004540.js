...
function action(mode, type, selection) {
	...
	talk+= "이번 주 자네에게 부탁할 일은 아래와 같다네.\r\n\r\n";
	    ...
	    var text2 = "자, 여기 #i1713000# #z1713000#를 3개 드렸습니다. 가져다 주신 아이템은 연구에 큰 도움이 될 거라네.\r\n\r\n";
	    text2 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n";
	    text2 += "#i1713000# #b#z1713000# #r#e3 개#k#n\r\n";
                cm.sendOk(text2);
