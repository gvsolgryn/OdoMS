var itmelist = [
  ...
  /*  [2430031, 8000, 1], //아케인심볼 : 여로 20렙
    ...
    [2633616, 20000, 1], // 어센틱심볼 : 세르니움 11렙
    [2633336, 20000, 1], // 어센틱심볼 : 아르크스 11렙
    [2439999, 30000, 1], // 어센틱심볼 : 오디움 11렙*/
    [2430030, 20000, 1], // 보스 초기화권0렙

    [2633616, 30000, 1], // 보스 초기화권
    ...
    [5062005, 3000, 1], // 어메이징 미라클 큐브
    [5062503, 5000, 1], // 화이트 에디셔널 큐브
    [2049360, 4000, 1], // 놀장강
    [2435899, 10000, 1], // 스페셜 위대한 소울
];
