    ...
    switch (cm.getPlayer().getMapId()) {
        ...
        case 993080400:
            ...
            if (status == 0) {
                ...
                if (mobcount == 0) {
                    ...
                    talk += "그렇다면 #b#e#i4319997##z4319997# " + coinqty + "개#k#n를 받아갈 수 있다."
                    cm.sendNext(talk);
                }
            } else if (status == 1) {
                if (mobcount == 0) {
                ...
                talk += "- 지급 아이템 #b#i4319997##z4319997# : " + coinqty + "개#k\r\n\r\n"
		...
		date2 = time.getDate() < 10 ? "0"+time.getDate() : time.getDate();
  		date = year+""+month+""+date2;
                    cm.getClient().setKeyValue("AdventureDrill"+date,"1");
                    //cm.setKeyValue(date, "AdventureDrill", "1");
                    cm.gainItem(4319997, coinqty);
                    eim.restartEventTimer(100);
                    cm.dispose();
                    return;
                } else {
