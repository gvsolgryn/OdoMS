...
var items = [
   {
      'itemid': 1005980, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1009984, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1009984, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042433, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042985, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042985, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062285, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062985, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062985, 1]] //성공시 지급되는 아이템
   },

   {
      'itemid': 1005981, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1009985, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1009985, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042434, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042986, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042986, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062286, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062986, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062986, 1]] //성공시 지급되는 아이템
   },

   {
      'itemid': 1005982, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1009986, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1009986, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042435, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042987, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042987, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062287, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062987, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062987, 1]] //성공시 지급되는 아이템
   },

   {
      'itemid': 1005983, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1009987, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1009987, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042436, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042988, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042988, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062288, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062988, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1062988, 1]] //성공시 지급되는 아이템
   },

   {
      'itemid': 1005984, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1009988, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1009988, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1042437, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1042989, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
      'fail': [[1042989, 1]] //성공시 지급되는 아이템
   },
   {
      'itemid': 1062289, 'qty': 1, 'allstat': 0, 'atk': 0, //템id, 수량, 추가스탯, 추가공격력, 스탯은 장비템에만 적용
      'recipes': [[1062989, 1], [4319999, 30000], [4319995, 30]], 'price': 50000000000, 'chance': 100, //재료, 비용, 확률
