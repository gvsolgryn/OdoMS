...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        말 += "210레벨 선물 상자는 #r계정당 1회#k"+검정+"만 받을 수 있습니다! (꼭 인벤토리의 공간을 여유롭게남겨두세요)"
        ...
        cm.gainItem(2631527, 30); //경코젬
        cm.gainItem(4310248, 1000); //코인
        cm.gainItem(5068300, 3); //원기베리
        cm.gainItem(5069100, 1); //루나크리스탈
        cm.gainItem(2437128, -1); //회수
