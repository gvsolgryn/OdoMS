...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        말 += "250레벨 선물 상자는 #r계정당 1회#k"+검정+"만 받을 수 있습니다! (꼭 인벤토리의 공간을 여유롭게남겨두세요)"
        ...
        cm.gainItem(3014005, 1); //명예의 상징
        cm.gainItem(4310248, 4000); //코인
        ...
        cm.gainItem(4001716, 5); //정착금10억
        cm.gainItem(5060048, 5); //애플
        cm.gainItem(2437132, -1); //회수
