...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            Packages.server.MapleInventoryManipulator.addId_Item(cm.getClient(), 5000930, 1, "", Packages.client.inventory.MaplePet.createPet(5000930, -1), 365, "", false);
            cm.sendOk("#fs11#" + 검정 + " #i5000930# #b#z5000930#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5000931# #b#z5000931#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
        } else if (selection == 2) {
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5000932# #b#z5000932#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
        } else if (selection == 3) {
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002079# #b#z5002079#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
        } else if (selection == 4) {
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002080# #b#z5002080#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
        } else if (selection == 5) {
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002081# #b#z5002081#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
        } else if (selection == 6) {
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002197# #b#z5002197#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
        } else if (selection == 7) {
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002356# #b#z5002356#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002357# #b#z5002357#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002358# #b#z5002358#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.");
            cm.gainItem(2430068, -1);
            cm.dispose();
        }
    }
