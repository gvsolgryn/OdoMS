...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            inz.setExpiration((new Date(time.getFullYear(), time.getMonth(), time.getDate(), 0, 0, 0, 0)).getTime() + (1000 * 60 * 60 * 24 * 365));
            ...
            cm.sendOk("#fs11#" + 검정 + " #i5002239# #b#z5002239#" + 검정 + "을 지급했다네! 캐시창을 확인해보게.", 9401232);
