		...
		if (cm.getKeyValue(26544, "sc") == -1) {
			if (cm.getKeyValue(26544, "c") < 3) {
				if (cm.getKeyValue(26544, "c") == -1) {
					cm.getPlayer().setKeyValue(26544, "c", "1", true);
					cm.getPlayer().setKeyValue(26544, "0", "0", true);
				} else {
					cm.getPlayer().setKeyValue(26544, "c", (cm.getKeyValue(26544, "c") + 1) + "", true);
					cm.getPlayer().setKeyValue(26544, (cm.getKeyValue(26544, "c") - 1) + "", "0", true);
				}
				...
				cm.hairroom(true, 0, cm.getPlayer().getKeyValue(26544, "c"));
				cm.dispose();
			} else {
