...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        말 = "#fs11#" + 연파랑 + "#z1712006##k " + 검정 + "아이템에 부여될 스텟을 선택해보게나.\r\n"
        말 += "#fc0xFFD5D5D5#───────────────────────────#k" + 검정 + "\r\n";
        말 += "#L0##i1712006# 저는 " + 빨강 + "STR 스텟#k" + 검정 + "을 부여 받고 싶습니다.\r\n"
        말 += "#L1##i1712006# 저는 " + 파랑 + "DEX 스텟#k" + 검정 + "을 부여 받고 싶습니다.\r\n"
        말 += "#L2##i1712006# 저는 " + 노랑 + "INT 스텟#k" + 검정 + "을 부여 받고 싶습니다.\r\n"
        말 += "#L3##i1712006# 저는 " + 초록 + "LUK 스텟" + 검정 + "을 부여 받고 싶습니다.\r\n"
        if (cm.getPlayer().getJob() == 3600 || cm.getPlayer().getJob() == 3610 || cm.getPlayer().getJob() == 3611 || cm.getPlayer().getJob() == 3612) {
            말 += "#L4##i1712006# 저는 " + 보라 + "STR,DEX,LUK 스텟" + 검정 + "을 부여 받고 싶습니다.\r\n"
        }
        if (cm.getPlayer().getJob() == 3001 || cm.getPlayer().getJob() == 3120 || cm.getPlayer().getJob() == 3121 || cm.getPlayer().getJob() == 3122) {
            말 += "#L5##i1712006# 저는 " + 검빨강 + "HP 스텟" + 검정 + "을 부여 받고 싶습니다.\r\n"
        } 
        ...
        if (힘 == 1) {
            말 = "#fs11#" + 파랑 + "#z1712006##k" + 검정 + " 아이템이 성공적으로 성장되었네! 인벤토리를 확인해보게나. 크크.\r\n\r\n"
            말 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
            말 += "#i1712006# #b#z1712006##k\r\n"
            말 += "" + 검정 + "성장 레벨 : 20\r\n"
            말 += "" + 검정 + "성장치 : MAX\r\n"
            말 += "" + 빨강 + "STR : +2200\r\n"
            말 += "" + 빨강 + "ARC : +220\r\n"
            ...
            var inz = MapleItemInformationProvider.getInstance().getEquipById(1712006);
            inz.setStr(2200);
            inz.setArcLevel(20);
            inz.setArc(220);
            ...
            말 = "#fs11#" + 보라 + "#z1712006##k" + 검정 + " 아이템이 성공적으로 성장되었네! 인벤토리를 확인해보게나. 크크.\r\n\r\n"
            말 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
            말 += "#i1712006# #b#z1712006##k\r\n"
            말 += "" + 검정 + "성장 레벨 : 20\r\n"
            말 += "" + 검정 + "성장치 : MAX\r\n"
            ...
            말 = "#fs11#" + 검빨강 + "#z1712006##k" + 검정 + " 아이템이 성공적으로 성장되었네! 인벤토리를 확인해보게나. 크크.\r\n\r\n"
            말 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
            말 += "#i1712006# #b#z1712006##k\r\n"
            말 += "" + 검정 + "성장 레벨 : 20\r\n"
            말 += "" + 검정 + "성장치 : MAX\r\n"
