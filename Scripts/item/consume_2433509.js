...
function action(M, T, S) {
	...
	if (St == 0) {
		...
		if (cm.getPlayer().getJob() == 10112) {
			...
			cm.sendOkS("#fs11##fc0xFF000000#자네의 여정에 힘이 됐으면 하는 마음에 #fc0xFFFF3300##e쓸만한 옵션#fc0xFF000000##n을 부여해놨다네! #fc0xFF990033#[HEINZ]#fc0xFF000000#에서 즐거운 시간 보내시게\r\n#b"
				+ "  #i1004404:# #t1004404:#\r\n"
				+ "  #i1052893:# #t1052893:#\r\n"
				+ "  #i1032040:# #t1032040:#\r\n"
				+ "  #i1132228:# #t1132228:#\r\n"
		...
		cm.sendSimpleS(selStr, 4, 9062286);
