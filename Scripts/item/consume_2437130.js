...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        말 += "230레벨 선물 상자는 #r계정당 1회#k"+검정+"만 받을 수 있습니다! (꼭 인벤토리의 공간을 여유롭게남겨두세요)"
        ...
        cm.gainItem(4310248, 2000); //코인
        cm.gainItem(5068300, 3); //원기베리
        cm.gainItem(2049360, 6); //놀장
        cm.gainItem(5069100, 1); //크리스탈
        cm.gainItem(2633912, 1); //앱솔무기
        cm.gainItem(2633913, 4); //앱솔방어구
        cm.gainItem(4310058, 20); //매그코인
        cm.gainItem(5060048, 5); //애플
        cm.gainItem(4001716, 3); //10억
        cm.gainItem(2437130, -1); //회수
