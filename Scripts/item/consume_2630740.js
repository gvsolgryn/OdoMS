...
function action(M, T, S)
{
	...
	if(St == 0)
	{
		...
		if (cm.getPlayer().getJob() == 10112) {
			...
			cm.sendOkS("#b#h ##k님의 여정을 돕고자, 아이템들에 #e#r상당한 추가 옵션#k#n을 부여했습니다. 아이템들은 #e#7일#n#k후 삭제됩니다.\r\n#r#e(제로 직업군은 무기를 획득할 수 없습니다)#n\r\n\r\n#b"
		...
		selStr = "아일랜드에 오신 #b#h ##k님을 위해 #e#r7일#n#k간 대여되는 #e#b블랙 방어구 세트#n#k와 함께 지급받을 #e#b블랙 무기#n#k#k#n를 선택해주세요.\r\n#e#r7일#n#k 후 지급받은 아이템은 자동 삭제됩니다.\r\n\r\n";
	...
	else if(St == 1)
	{
		...
		if (cm.getPlayer().getKeyValue(1912211, "timerf") == -1 && cm.getPlayer().getLevel() <= 20) {
			cm.sendOkS("#b#h ##k님의 여정을 돕고자, 아이템들에 #e#r상당한 추가 옵션#k#n을 부여했습니다. 아이템들은 #e#r7일#n#k후 삭제됩니다.\r\n#r#e(제로 직업군은 무기를 획득할 수 없습니다)#n\r\n\r\n#b"
			+ "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
			+ "  #i1004404:# #t1004404:#\r\n"
			+ "  #i1052893:# #t1052893:#\r\n"
			+ "  #i1102799:# #t1102799:#\r\n"
