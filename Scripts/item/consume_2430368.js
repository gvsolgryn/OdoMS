...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        말 = "#fs11#" + 검정 + "스네이크 아이템은 " + 초록 + "에디셔널 잠재능력#k" + 검정 + "에 특수한 옵션이 달려있다네! 원하는 아이템을 선택해보게나!\r\n"
        말 += "#fc0xFFD5D5D5#───────────────────────────#k" + 검정 + "\r\n";
        ...
        if (selection == 0) {
            말 = "#fs11#" + 검정 + "자네는 " + 파랑 + "#z1113087##k" + 검정 + "을 선택했군! " + 초록 + "에디셔널 잠재능력#k" + 검정 + "에 부여될 옵션을 선택해보게! 크크.\r\n"
            말 += "#fc0xFFD5D5D5#───────────────────────────#k" + 검정 + "\r\n";
            말 += "#L0#" + 보라 + "아이템 획득량 60%#k" + 검정 + "를 선택하겠습니다.#l\r\n"
            말 += "#L1#" + 보라 + "메소 획득랑 60%" + 검정 + "를 선택하겠습니다.#l\r\n"
            cm.sendOkS(말, 0x04, 3005560);
        } else if (selection == 1) {
            말 = "#fs11#" + 검정 + "자네는 " + 파랑 + "#z1122219##k" + 검정 + "를 선택했군! " + 초록 + "에디셔널 잠재능력#k" + 검정 + "에 부여될 옵션을 선택해보게! 크크.\r\n"
            말 += "#fc0xFFD5D5D5#───────────────────────────#k" + 검정 + "\r\n";
        ...
        if (selection == 0) {
            말 = "#fs11#" + 검정 + "" + 파랑 + "#z1113087##k" + 검정 + " 아이템에 " + 초록 + "에디셔널 잠재능력#k" + 검정 + "을 부여했네! 인벤토리에서 확인해보게!\r\n\r\n"
            ...
            말 = "#fs11#" + 검정 + "" + 파랑 + "#z1122219##k" + 검정 + " 아이템에 " + 초록 + "에디셔널 잠재능력#k" + 검정 + "을 부여했네! 인벤토리에서 확인해보게!\r\n\r\n"
            말 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
