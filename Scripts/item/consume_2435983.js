...
var allstat = 75, atk = 40; // 1회당 올스텟, 공마 증가치
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var txt = "#fs11##fc0xFF000000#장비 아이템을 #b#z2635903##fc0xFF000000#로 강화할 수 있다는 사실을 알고 계시나요? #b원하시는 캐시아이템#fc0xFF000000#을 골라주세요.\r\n#r(최대 1회 올스텟 150/ 공,마 100)#k\r\n";
