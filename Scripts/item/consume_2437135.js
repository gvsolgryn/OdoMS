...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        말 += "275레벨 선물 상자는 #r계정당 1회#k"+검정+"만 받을 수 있습니다! (꼭 인벤토리의 공간을 여유롭게남겨두세요)"
        ...
        cm.gainItem(3014028, 1); //의자
        cm.gainItem(4310248, 7500); //코인
        cm.gainItem(5068300, 5); //원기베리
        cm.gainItem(5069100, 2); //크리스탈
        cm.gainItem(5062006, 50); //플래큐브
        cm.gainItem(5062002, 50); //마미큐
        cm.gainItem(5062005, 15); //어메이징
        cm.gainItem(5060048, 10); //애플
        cm.gainItem(2437135, -1); //회수
