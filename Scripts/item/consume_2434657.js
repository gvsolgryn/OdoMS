...
function action(M, T, S)
{
	...
	if(St == 0)
	{
		...
		if (cm.getPlayer().getJob() == 10112) {
			...
			cm.sendOkS("#fs11##fc0xFF000000#자네의 여정에 힘이 됐으면 하는 마음에 #fc0xFFFF3300##e쓸만한 옵션#fc0xFF000000##n을 부여해놨다네! #fc0xFF990033#[Nero Stroy]#fc0xFF000000#에서 즐거운 시간 보내시게\r\n#b"
			+ "  #i1003561:# #t1003561:#\r\n"
			+ "  #i1052467:# #t1052467:#\r\n"
			+ "  #i1032148:# #t1032148:#\r\n"
			+ "  #i1132161:# #t1132161:#\r\n"
	...
	cm.getPlayer().getClient().getSession().writeAndFlush(CWvsContext.InventoryPacket.updateInventoryItem(false, MapleInventoryType.EQUIPPED, item));
		...
		selStr = "#fs 11##fc0xFF990033#[Nero Story]#fc0xFF000000#에 온걸 진심으로 환영하네! 이건 자네의 모험을 도와줄 지원 장비일세, 직업에 맞는 무기를 선택해보게나.#b\r\n";
	...
	else if(St == 1)
	{
		...
		cm.sendOkS("#fs11##fc0xFF000000#자네의 여정에 힘이 됐으면 하는 마음에 #fc0xFFFF3300##e쓸만한 옵션#fc0xFF000000##n을 부여해놨다네! #fc0xFF990033#[Nero Story]#fc0xFF000000#에서 즐거운 시간 보내시게\r\n#b"
			+ "  #i1003561:# #t1003561:#\r\n"
			+ "  #i1052467:# #t1052467:#\r\n"
			+ "  #i1032148:# #t1032148:#\r\n"
			+ "  #i1132161:# #t1132161:#\r\n"
		...
		addOption(S, true);
		cm.gainItem(2434657, -1);
        cm.gainItem(3700510, 1); //칭호
        cm.gainItem(2430048, 1); //프리패스
        cm.gainItem(2000005, 500); //파엘
