...
var need = 2633608, qty = 1;

var items = [1222122, 1232122, 1242139, 1242141, 1262051, 1272040, 1282040, 1292022, 1302355, 1312213, 1322264, 1332289, 1362149, 1372237, 1382274, 1402268, 1412189, 1422197, 1432227, 1442285, 1452266, 1462252, 1472275, 1482232, 1492245, 1522152, 1532157, 1582044, 1592022, 1213022, 1214022];

var pot = [
	{'name' : "공격력 +9%", 'code' : 30051},
	{'name' : "마력 +9%", 'code' : 30052},
	{'name' : "보스 공격시 데미지 +30%", 'code' : 30602},
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg += "올스탯 : #b+400#k"+enter;
		msg += "공격력 : #b+400#k"+enter;
		msg += "마　력 : #b+400#k"+enter;
		msg += "보스 공격시 데미지 : #b+20%#k"+enter;
		msg += "몬스터 방어력 무시 : #b+20%#k"+enter;
