...
bossname = [
    ...
    ["루시드", 19, 34364, "Easy_Lucid", 3685, "lasttime", "Normal_Lucid", "Hard_Lucid"],
    ["윌", 23, 35100, "Normal_Will", 3658, "lasttime", "Hard_Will"],
    ["더스크", 26, 35137, "Normal_Dusk", 3680, "lasttime", "Chaos_Dusk"],
    ["진 힐라", 24, 35260, "Normal_JinHillah", 3673, "lasttime"],
    ["듄켈", 27, 35138, "Normal_Dunkel", 3681, "lasttime", "Hard_Dunkel"],
           ]
function start() {
    status = -1;
    action (1, 0, 0);
