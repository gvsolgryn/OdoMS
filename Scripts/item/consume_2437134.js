...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        말 += "270레벨 선물 상자는 #r계정당 1회#k"+검정+"만 받을 수 있습니다! (꼭 인벤토리의 공간을 여유롭게남겨두세요)"
        ...
        cm.gainItem(4310248, 7000); //코인
        cm.gainItem(5068300, 3); //원기베리
        cm.gainItem(5069100, 1); //크리스탈
        cm.gainItem(5060048, 10); //크리스탈
        cm.gainItem(2048717, 1000); //영환
        cm.gainItem(2048767, 1000); //검환
        cm.gainItem(5062006, 30); //플래큐브
        cm.gainItem(5062002, 30); //마미큐
        cm.gainItem(5062005, 10); //어메이징
        cm.gainItem(1713001, 30); //아르크스
        cm.gainItem(2437134, -1); //회수
