...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        말 += "#i1122001# #b#z1122001##k\r\n"
        말 += "#i4310291# #b#z4310291# 150개#k\r\n"
        말 += "#i5200002# #b15,000,000 메소#k\r\n"
        var inz = MapleItemInformationProvider.getInstance().getEquipById(1122001);
        ...
        cm.gainItem(4310291, 150);
        cm.gainMeso(15000000);
        cm.gainItem(2430012, -1);
        cm.sendOk(말);
        cm.dispose();
    }
}
