...
function setup(mapid) {
    ...
    map = parseInt(mapid);
    while (em.getInstance("Normal_Zakum" + a) != null) {
        a = Randomizer.nextInt();
    }
    var eim = em.newInstance("Normal_Zakum" + a);
...
function monsterValue(eim, mobId) {
    ...
    if (mobId == 8800002) {
	if (player.getV("d_n_zakum_clear") != null)
		player.addKV("d_n_zakum_clear", "1");
