...
function setup(mapid) {
    ...
    map = parseInt(mapid);
    while (em.getInstance("Normal_Kawoong" + a) != null) {
        a = Randomizer.nextInt();
    }
    var eim = em.newInstance("Normal_Kawoong" + a);
...
function spawnMonster(eim) {
    var map = eim.getMapInstance(0);
    var mob = em.getMonster(8880200);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(620, 298));
    var mob2 = em.getMonster(8880202);
    eim.registerMonster(mob2);
    map.spawnMonsterOnGroundBelow(mob2, new java.awt.Point(620, 298));
}
