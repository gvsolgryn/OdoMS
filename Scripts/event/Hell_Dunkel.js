...
function setup(mapid) {
    ...
    map = parseInt(mapid);
    while (em.getInstance("Hell_Dunkel" + a) != null) {
        a = Randomizer.nextInt();
    }
    var eim = em.newInstance("Hell_Dunkel" + a);
...
function spawnMonster(eim) {
    var map = eim.getMapInstance(0);
    var mob = em.getMonster(8645066, false, true);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(0, 20));
    var mob2 = em.getMonster(8645068, false, true);
