...
function setup(mapid) {
    ...
    map = parseInt(mapid);
    while (em.getInstance("Easy_Arkarium" + a) != null) {
        a = Randomizer.nextInt();
    }
    var eim = em.newInstance("Easy_Arkarium" + a);
...
function changedMap(eim, player, mapid) {
    if (mapid != 272020200 && mapid != 272020210 && mapid != 272020310 && mapid != 272020410 && mapid != 272020300 && mapid != 272020500 && mapid != 272020600 && mapid != 272020410) {
