...
function setup(mapid) {
    ...
    map = parseInt(mapid);
    while (em.getInstance("Easy_VonLeon" + a) != null) {
        a = Randomizer.nextInt();
    }
    var eim = em.newInstance("Easy_VonLeon" + a);
...
function changedMap(eim, player, mapid) {
    if (mapid != 211070100 && mapid != 211070101 && mapid != 211070550 && mapid != 211070450 && mapid != 211070101 && mapid != 211070103 && mapid != 211070105 && mapid != 211070350 && mapid != 211070450 && mapid != 211070550) {
