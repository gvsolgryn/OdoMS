...
function setup(mapid) {
    ...
    map = parseInt(mapid);
    while (em.getInstance("Chaos_Mitsuhide" + a) != null) {
        a = Randomizer.nextInt();
    }
    var eim = em.newInstance("Chaos_Mitsuhide" + a);
...
function spawnMonster(eim) {
    var map = eim.getMapInstance(0);
    var mob = em.getMonster(9601623);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(358, 306));
}
