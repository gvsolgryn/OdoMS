...
function spawnMonster(eim, instance, mobid, x, y) {
    ...
    if (stage == 4) {
	map.broadcastMessage(MobPacket.Lucid3rdPhase(0));
    }
}
...
function monsterValue(eim, mobId) {
    ...
    if (mobId == 8880141 && stage == 1) {
        ...
        spawnMonster(eim, 3, 8880153, 601, -60);
...
function WarptoNextStage(eim) {
    ...
    if (stage == 1) {
        ...
        spawnMonster(eim, stage, 8880165, 1021, 43);
        spawnMonster(eim, stage, 8880168, 1021, 43);
        spawnMonster(eim, stage, 8880169, 1021, 43);
    } else if (stage == 3) {
        spawnMonster(eim, stage, 8880151, 292, -135);
        spawnMonster(eim, stage, 8880175, 292, -125);
        spawnMonster(eim, stage, 8880178, 292, -125);
        spawnMonster(eim, stage, 8880179, 292, -125);
    } else if (stage == 5) {
